...
As an example, you could filter the list to show only tracked entities where you have been assigned an event: Click the "Assigned to" filter (1), select "Me" (2) and then "Apply" the changes (3).
