    ...
    "config": [
        {
            ...
            "pluginSource": "https://debug.dhis2.org/dev"
        },
        {
            "title": {
                "es": "Tratamiento",
            ...
            "configKey": "treatment",
            "programId": "IpHINAT79UW",
            "pluginSource": "https://developers.dhis2.org/docs/capture-plugins/developer/getting-started"
        },
        {
            "title": {
            ...
            "pluginSource": "https://docs.dhis2.org/en/home.html"
        }
    ]
}
```
...
| `pluginSource` | Yes | The URL of the plugin. Must point to a valid plugin installed on the instance. |
