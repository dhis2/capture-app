Feature: User interacts with Search page
    ...
    Scenario: Enroll in current program
        Given you are in the search page with the program ur1Edk5Oe2n and org unit DiszpKrYNg8 being preselected from the url
        And you expand the attributes search area
        When you fill in the first and last name with values that will return results
        And you click search
        And you can see the first page of the results
        ...
        And you click button to enroll the program TB program
        Then you should be taken to create new page with org unit DiszpKrYNg8, program ur1Edk5Oe2n, tei EMbxhELjY6L preselected