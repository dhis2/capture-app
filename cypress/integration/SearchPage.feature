Feature: User interacts with Search page
  ...
  Scenario: Tracker program > Searching using attributes throws error
    Given you are on the default search page
    And you select the search domain Malaria Case diagnosis
    And you expand the attributes search area
  ...
  Scenario: Tracker program > Searching using attributes is invalid because terms typed contain nothing but spaces
    Given you are on the default search page
    And you select the search domain Malaria Case diagnosis
    And you expand the attributes search area
  ...
  Scenario: Tracker program > Searching using attributes is invalid after clearing all search terms
    Given you are on the default search page
    And you select the search domain Malaria Case diagnosis
    And you expand the attributes search area
  ...
  Scenario: Tracker program > Searching using attributes navigates user to the dashboard view
    Given you are on the default search page
    And you select the search domain Malaria Case diagnosis
    And you expand the attributes search area
    And you fill in the last name with values that will return results
  ...
  Scenario: Tracker program > Searching using attributes Program domain has disabled pagination
    Given you are on the default search page
    And you select the search domain Malaria Case diagnosis
    And you expand the attributes search area
  ...
  # Tracked entity type
  Scenario: TEType domain > Searching using attributes is invalid after clearing all search terms
    Given you are on the default search page
  ...
  Scenario: TEType domain > Searching using attributes is invalid because terms typed contain nothing but spaces
    Given you are on the default search page
    And you select the search domain Person
    And you expand the attributes search area
    When you fill the values with nothing but spaces
  ...
  Scenario: TEType domain > Searching using attributes domain has disabled pagination
    Given you are on the default search page
    And you select the search domain Person
    And you expand the attributes search area
