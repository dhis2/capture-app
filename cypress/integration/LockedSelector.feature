Feature: User uses the LockedSelector to navigate
  ...
  Scenario: Enrollment event edit page > resetting the tei
    Given you land on the enrollment page by having typed the /#/enrollmentEventEdit?programId=IpHINAT79UW&orgUnitId=UgYg0YW7ZIh&teiId=pybd813kIWx&enrollmentId=FS085BEkJo2&eventId=kNn9HkRjk1c&stageId=A03MvHHogjR
    When you reset the tei selection
    Then you navigated to the main page

  Scenario: Enrollment event edit page > resetting the program
    Given you land on the enrollment page by having typed the /#/enrollmentEventEdit?programId=IpHINAT79UW&orgUnitId=UgYg0YW7ZIh&teiId=fhFQhO0xILJ&enrollmentId=gPDueU02tn8&eventId=lQQyjR73hHk&stageId=A03MvHHogjR
    When you reset the program selection
  ...
  Scenario: Enrollment event new page > resetting the tei
    Given you land on the enrollment page by having typed the /#/enrollmentEventNew?programId=IpHINAT79UW&orgUnitId=UgYg0YW7ZIh&teiId=pybd813kIWx&enrollmentId=FS085BEkJo2&stageId=A03MvHHogjR
    When you reset the tei selection
    Then you navigated to the main page

  Scenario: Enrollment event new page > resetting the program
    Given you land on the enrollment page by having typed the /#/enrollmentEventNew?programId=IpHINAT79UW&orgUnitId=UgYg0YW7ZIh&teiId=fhFQhO0xILJ&enrollmentId=gPDueU02tn8&stageId=A03MvHHogjR
    When you reset the program selection
    Then you see message explaining you need to select a program
