Feature: User interacts with Enrollment page
  ...
  Scenario: Org unit is not auto-switched when opening enrollment dashboard
    ...
    Then you should be redirect to #/enrollment?enrollmentId=avqvQMtX8DG&orgUnitId=DiszpKrYNg8&programId=IpHINAT79UW&teiId=btoHJM9byeF
