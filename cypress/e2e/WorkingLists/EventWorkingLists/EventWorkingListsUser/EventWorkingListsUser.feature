...
Scenario: Save and load view with active filters for - TEXT
...
@v>=42
Scenario: Save and load view with isEmpty filtering for - TEXT
  Given you open the main page with Ngelehun and event program text filter context
...
Scenario: Save and load view with active filters for - BOOLEAN, INTEGER, NUMBER, INTEGER_POSITIVE, DATE, ORGANISATION_UNIT
...
@v>=42
Scenario: Save and load view with isEmpty filtering for - BOOLEAN, INTEGER, NUMBER, INTEGER_POSITIVE, DATE, ORGANISATION_UNIT, COORDINATE, FILE_RESOURCE
  Given you open the main page with Ngelehun and Inpatient morbidity and mortality context
