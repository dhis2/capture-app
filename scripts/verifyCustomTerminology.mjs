...
const CUSTOM_TERMS = [
    ...
    { words: ['notes'], suggestion: 'no plural custom label — allowlist if intentional' },
    { words: ['relationship'], suggestion: '{{relationshipLabel}}' },
    { words: ['relationships'], suggestion: 'no plural custom label — allowlist if intentional' },
    { words: ['attribute'], suggestion: '{{attributeLabel}}' },
    { words: ['attributes'], suggestion: 'no plural custom label — allowlist if intentional' },
