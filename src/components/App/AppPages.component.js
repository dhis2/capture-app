...
import { EnrollmentEventEditPage } from 'capture-core/components/Pages/Enrollment/Event/Edit/EnrollmentEventEditPage.container';
...
export const AppPages = () => (
    <Switch>
        ...
        <Route path="/enrollment/event/edit" component={EnrollmentEventEditPage} />
