...
import { EnrollmentAddEventDefaultPage } from 'capture-core/components/Pages/EnrollmentAddEvent';
...
export const AppPages = () => (
    <Switch>
        ...
        <Route path="/enrollmentEventNew" component={EnrollmentAddEventDefaultPage} />
