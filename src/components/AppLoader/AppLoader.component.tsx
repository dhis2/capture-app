...
import { LoadingMaskForPage } from '../../core_modules/capture-core/components/LoadingMasks';
import { DisplayException } from '../../core_modules/capture-core/utils/exceptions';
import { useNavigate } from '../../core_modules/capture-core/utils/routing';
import { makeQuerySingleResource } from '../../core_modules/capture-core/utils/api';
import { environments } from '../../core_modules/capture-core/constants';
import { buildUrl } from '../../core_modules/capture-core-utils';
import { initFeatureAvailability } from '../../core_modules/capture-core-utils/featuresSupport';
import { initializeAsync } from './init';
import { getStore } from '../../store/getStore';
import type { Store } from 'redux';

type Props = {
    onRunApp: (store: Store) => void;
    onCacheExpired: () => void;
};
