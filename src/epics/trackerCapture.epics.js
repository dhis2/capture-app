...
import { openNewEventPageLocationChangeEpic } from 'capture-core/components/Pages/NewEvent/epics/newEvent.epics';
...
import { loadViewEventDataEntryEpic } from 'capture-core/components/Pages/ViewEvent/EventDetailsSection/ViewEventDataEntry/viewEventDataEntry.epics';
import {
...
import { goingOnlineEpic } from 'capture-core/components/Connectivity/connectivity.epics';
import { networkMonitorStatusEpic } from 'capture-core/components/NetworkStatusBadge/NetworkStatusBadge.epics';
import {
  setOrgUnit,
  setProgram,
  goBackToListContext,
...
import { resetProgramAfterSettingOrgUnitIfApplicableEpic } from 'capture-core/components/Pages/epics/resetProgramAfterSettingOrgUnitIfApplicable.epic';
import { resetCategoriesAfterSettingOrgUnitIfApplicableEpic } from 'capture-core/components/Pages/epics/resetCategoriesAfterSettingOrgUnitIfApplicable.epic';
import { calculateSelectionsCompletenessEpic } from 'capture-core/components/Pages/epics/calculateSelectionsCompleteness.epic';
import { includeFiltersWithValueAfterColumnSortingEpic } from 'capture-core/components/Pages/MainPage/WorkingListsCommon';
import {
...
import { asyncUpdateFieldEpic } from 'capture-core/components/D2Form';
import { filterFormFieldOrgUnitsEpic } from 'capture-core/components/D2Form/field/Components/OrgUnitField/orgUnitFieldForForms.epics';

import { teiSearchFilterOrgUnitsEpic } from 'capture-core/components/TeiSearch/SearchOrgUnitSelector/searchOrgUnitSelector.epics';
...
import { setTrackedEntityTypeIdOnUrlEpic } from '../core_modules/capture-core/components/TrackedEntityTypeSelector/TrackedEntityTypeSelector.epics';
import {
...
import { startNewEnrollmentDataEntrySelfInitialisationEpic } from '../core_modules/capture-core/components/DataEntries/EnrollmentRegistrationEntry/EnrollmentRegistrationEntry.epics';
import { startNewTeiDataEntrySelfInitialisationEpic } from '../core_modules/capture-core/components/DataEntries/TeiRegistrationEntry/TeiRegistrationEntry.epics';
