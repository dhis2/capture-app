...
describe('rules engine effects with functions', () => {
    ...
    const programRules = [{ id: 'CTzRoPyvf8v', condition: 'true', displayName: 'Testing the functions!', programId: 'eBAyeGv0exc', programRuleActions: [{ id: 'Lpqx5rrAHLU', content: "d2:count('age') = ", data: "d2:count('age')", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'yXQ4I6yOOfn', content: "d2:concatenate( 'me', 'me', 123, 'me') = ", data: "d2:concatenate( 'me', 'me', 123,'me')", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'stIerGak0tC', content: 'd2:left(#{age}, 3) = ', data: 'd2:left(#{age}, 3)', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'jMpkiDpDvm0', content: 'd2:addDays( V{current_date}, 1000000 ) = ', data: 'd2:addDays( V{current_date}, 1000000 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'N78B44mR8wR', content: 'display age = ', data: '#{age}', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'dFCnXmNgXVi', content: 'd2:daysBetween( V{current_date}, V{event_date}) = ', data: 'd2:daysBetween( V{current_date}, V{event_date})', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'VEKUmW0BnE2', content: "d2:length( 'dhis2 rocks' ) = ", data: "d2:length( 'dhis2 rocks' )", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'hVNEbmJeSp7', content: 'd2:floor( 11.5 ) =', data: 'd2:floor( 11.5 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'fYZ1RJP05RS', content: 'd2:oizp( -10000000 ) =', data: 'd2:oizp( -10000000 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'bb3XCU2X6C9', content: 'd2:yearsBetween( V{current_date}, V{event_date}) = ', data: 'd2:yearsBetween( V{current_date}, V{event_date})', programRuleActionType: 'DISPLAYTEXT' }, { id: 'l3pySvdPCQx', content: 'd2:right(#{age}, 3) = ', data: 'd2:right(#{age}, 3)', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'bLdy7lYJNHw', content: "d2:substring('hello everyone', 1, 3) = ", data: "d2:substring('hello everyone', 1, 3)", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'f6JPzdKJnRD', content: 'd2:round( 0 ) = ', data: 'd2:round( 0 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'Jdjf4M2kykV', content: 'd2:zing( -2 ) = ', data: 'd2:zing( -2 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'Yi3WNaZ49p6', content: 'd2:weeksBetween( V{event_date}, V{current_date} ) = ', data: 'd2:weeksBetween( V{event_date}, V{current_date} )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'pd1e1H9hXUk', content: "d2:split('give-me-more-values', '-', 1) = ", data: "d2:split('give-me-more-values', '-', 1)", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'SDnufGQ0dRi', content: 'd2:round( 12.5 ) = ', data: 'd2:round( 12.5 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'MMhYPzzhoYj', content: 'd2:modulus( 12 , 100 ) = ', data: 'd2:modulus( 12 , 100 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'C3q8RDnoTwh', content: 'd2:ceil(11.3) = ', data: 'd2:ceil(11.3)', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'Fmdqmm4v5Tz', content: "d2:countIfValue( 'age', 1 ) = ", data: "d2:countIfValue( 'age', 1 )", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'PNI4Y0i4sGr', content: 'd2:monthsBetween( V{current_date}, V{event_date}) = ', data: 'd2:monthsBetween( V{current_date}, V{event_date})', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'HjxTYoUPLyL', content: "d2:countIfZeroPos( 'age' ) = ", data: "d2:countIfZeroPos( 'age' )", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'vQxRXrNc2Vv', content: 'd2:zing( 1000 ) = ', data: 'd2:zing( 1000 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'qB3qeoYx2FR', content: "d2:hasValue( 'age' ) = ", data: "d2:hasValue( 'age' )", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'cDKjmynlLe7', content: 'org_unit = ', data: 'V{orgunit_code}', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'vydSXxFlSmT', content: "d2:countIfValue( 'gender', 'Male' ) = ", data: "d2:countIfValue( 'gender', 'Male' )", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'H61R9eeDE5T', content: 'd2:oizp( 10000000 ) = ', data: 'd2:oizp( 10000000 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }] }];
    const programRulesVariables = [{ id: 'RycV5uDi66i', dataElementId: 'qrur9Dvnyt5', displayName: 'age', programId: 'eBAyeGv0exc', programRuleVariableSourceType: 'DATAELEMENT_NEWEST_EVENT_PROGRAM', useNameForOptionSet: true }, { id: 'zINGRka3g9N', dataElementId: 'oZg33kd9taw', displayName: 'gender', programId: 'eBAyeGv0exc', programRuleVariableSourceType: 'DATAELEMENT_NEWEST_EVENT_PROGRAM', useNameForOptionSet: true }, { id: 'Zj7UnCAulEk.vV9UWAZohSf', displayName: 'Zj7UnCAulEk.vV9UWAZohSf', programRuleVariableSourceType: 'DATAELEMENT_CURRENT_EVENT', dataElementId: 'vV9UWAZohSf', programId: 'eBAyeGv0exc' }, { id: 'Zj7UnCAulEk.GieVkTxp4HH', displayName: 'Zj7UnCAulEk.GieVkTxp4HH', programRuleVariableSourceType: 'DATAELEMENT_CURRENT_EVENT', dataElementId: 'GieVkTxp4HH', programId: 'eBAyeGv0exc' }, { id: 'Zj7UnCAulEk.GieVkTxp4HH', displayName: 'Zj7UnCAulEk.GieVkTxp4HH', programRuleVariableSourceType: 'DATAELEMENT_CURRENT_EVENT', dataElementId: 'GieVkTxp4HH', programId: 'eBAyeGv0exc' }];
    const orgUnit = { id: 'DiszpKrYNg8', name: 'Ngelehun CHC' };
    const optionSet = { pC3N9N77UmT: { id: 'pC3N9N77UmT', displayName: 'Gender', version: 0, valueType: 'TEXT', options: [{ id: 'rBvjJYbMCVx', displayName: 'Male', code: 'Male', translations: [] }, { id: 'Mnp3oXrpAbK', displayName: 'Female', code: 'Female', translations: [] }] } };
    ...
    describe.each([
        [
            {},
            [
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'Lpqx5rrAHLU', message: "d2:count('age') =  0" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'yXQ4I6yOOfn', message: "d2:concatenate( 'me', 'me', 123, 'me') =  meme123me" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'stIerGak0tC', message: 'd2:left(#{age}, 3) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'jMpkiDpDvm0', message: 'd2:addDays( V{current_date}, 1000000 ) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'N78B44mR8wR', message: 'display age =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'dFCnXmNgXVi', message: 'd2:daysBetween( V{current_date}, V{event_date}) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'VEKUmW0BnE2', message: "d2:length( 'dhis2 rocks' ) =  11" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'hVNEbmJeSp7', message: 'd2:floor( 11.5 ) = 11' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'fYZ1RJP05RS', message: 'd2:oizp( -10000000 ) = 0' } },
                { type: 'DISPLAYTEXT', displayText: { id: 'bb3XCU2X6C9', message: 'd2:yearsBetween( V{current_date}, V{event_date}) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'l3pySvdPCQx', message: 'd2:right(#{age}, 3) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'bLdy7lYJNHw', message: "d2:substring('hello everyone', 1, 3) =  el" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'f6JPzdKJnRD', message: 'd2:round( 0 ) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'Jdjf4M2kykV', message: 'd2:zing( -2 ) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'Yi3WNaZ49p6', message: 'd2:weeksBetween( V{event_date}, V{current_date} ) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'pd1e1H9hXUk', message: "d2:split('give-me-more-values', '-', 1) =  me" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'SDnufGQ0dRi', message: 'd2:round( 12.5 ) =  13' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'MMhYPzzhoYj', message: 'd2:modulus( 12 , 100 ) =  12' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'C3q8RDnoTwh', message: 'd2:ceil(11.3) =  12' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'Fmdqmm4v5Tz', message: "d2:countIfValue( 'age', 1 ) =  0" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'PNI4Y0i4sGr', message: 'd2:monthsBetween( V{current_date}, V{event_date}) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'HjxTYoUPLyL', message: "d2:countIfZeroPos( 'age' ) =  " } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'vQxRXrNc2Vv', message: 'd2:zing( 1000 ) =  1000' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'qB3qeoYx2FR', message: "d2:hasValue( 'age' ) =  " } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'cDKjmynlLe7', message: 'org_unit =  Ngelehun CHC' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'vydSXxFlSmT', message: "d2:countIfValue( 'gender', 'Male' ) =  0" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'H61R9eeDE5T', message: 'd2:oizp( 10000000 ) =  1' } },
            ],
        ],
        [
            { oZg33kd9taw: 'Male', /* age */qrur9Dvnyt5: 0, eventDate: '2020-04-30T22:00:00.000Z' },
            [
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'Lpqx5rrAHLU', message: "d2:count('age') =  1" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'yXQ4I6yOOfn', message: "d2:concatenate( 'me', 'me', 123, 'me') =  meme123me" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'stIerGak0tC', message: 'd2:left(#{age}, 3) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'jMpkiDpDvm0', message: 'd2:addDays( V{current_date}, 1000000 ) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'N78B44mR8wR', message: 'display age =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'dFCnXmNgXVi', message: 'd2:daysBetween( V{current_date}, V{event_date}) =  4' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'VEKUmW0BnE2', message: "d2:length( 'dhis2 rocks' ) =  11" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'hVNEbmJeSp7', message: 'd2:floor( 11.5 ) = 11' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'fYZ1RJP05RS', message: 'd2:oizp( -10000000 ) = 0' } },
                { type: 'DISPLAYTEXT', displayText: { id: 'bb3XCU2X6C9', message: 'd2:yearsBetween( V{current_date}, V{event_date}) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'l3pySvdPCQx', message: 'd2:right(#{age}, 3) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'bLdy7lYJNHw', message: "d2:substring('hello everyone', 1, 3) =  el" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'f6JPzdKJnRD', message: 'd2:round( 0 ) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'Jdjf4M2kykV', message: 'd2:zing( -2 ) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'Yi3WNaZ49p6', message: 'd2:weeksBetween( V{event_date}, V{current_date} ) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'pd1e1H9hXUk', message: "d2:split('give-me-more-values', '-', 1) =  me" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'SDnufGQ0dRi', message: 'd2:round( 12.5 ) =  13' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'MMhYPzzhoYj', message: 'd2:modulus( 12 , 100 ) =  12' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'C3q8RDnoTwh', message: 'd2:ceil(11.3) =  12' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'Fmdqmm4v5Tz', message: "d2:countIfValue( 'age', 1 ) =  0" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'PNI4Y0i4sGr', message: 'd2:monthsBetween( V{current_date}, V{event_date}) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'HjxTYoUPLyL', message: "d2:countIfZeroPos( 'age' ) =  " } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'vQxRXrNc2Vv', message: 'd2:zing( 1000 ) =  1000' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'qB3qeoYx2FR', message: "d2:hasValue( 'age' ) =  true" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'cDKjmynlLe7', message: 'org_unit =  Ngelehun CHC' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'vydSXxFlSmT', message: "d2:countIfValue( 'gender', 'Male' ) =  1" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'H61R9eeDE5T', message: 'd2:oizp( 10000000 ) =  1' } },
            ],
        ],
        [
            ...
            [
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'Lpqx5rrAHLU', message: "d2:count('age') =  1" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'yXQ4I6yOOfn', message: "d2:concatenate( 'me', 'me', 123, 'me') =  meme123me" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'stIerGak0tC', message: 'd2:left(#{age}, 3) =  100' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'jMpkiDpDvm0', message: 'd2:addDays( V{current_date}, 1000000 ) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'N78B44mR8wR', message: 'display age =  1000000000' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'dFCnXmNgXVi', message: 'd2:daysBetween( V{current_date}, V{event_date}) =  4' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'VEKUmW0BnE2', message: "d2:length( 'dhis2 rocks' ) =  11" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'hVNEbmJeSp7', message: 'd2:floor( 11.5 ) = 11' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'fYZ1RJP05RS', message: 'd2:oizp( -10000000 ) = 0' } },
                { type: 'DISPLAYTEXT', displayText: { id: 'bb3XCU2X6C9', message: 'd2:yearsBetween( V{current_date}, V{event_date}) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'l3pySvdPCQx', message: 'd2:right(#{age}, 3) =  000' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'bLdy7lYJNHw', message: "d2:substring('hello everyone', 1, 3) =  el" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'f6JPzdKJnRD', message: 'd2:round( 0 ) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'Jdjf4M2kykV', message: 'd2:zing( -2 ) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'Yi3WNaZ49p6', message: 'd2:weeksBetween( V{event_date}, V{current_date} ) =  0' } },
