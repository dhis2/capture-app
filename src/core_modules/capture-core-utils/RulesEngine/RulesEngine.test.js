...
import rulesEffectsValueConverter from '../../capture-core/rulesEngineActionsCreator/converters/rulesEffectsValueConverter';
...
describe('rules engine effects with functions', () => {
    // these variables are shared between each test
    const constants = [{ id: 'Gfd3ppDfq8E', displayName: 'Commodity ordering overhead', value: 5 }, { id: 'bCqvfPR02Im', displayName: 'Pi', value: 3.14 }];
    ...
    const programRules = [{ id: 'CTzRoPyvf8v', condition: 'true', displayName: 'Testing the functions!', programId: 'eBAyeGv0exc', programRuleActions: [{ id: 'dEvMKWoR02j', content: "d2:substring('hello dhis 2', 6, 10) = ", data: "d2:substring('hello dhis 2', 6, 10)", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'fHdq0QUOcvk', content: "d2:length( 'dhis2 rocks' ) = ", data: "d2:length( 'dhis2 rocks' )", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'QCPTGiml5xp', content: 'd2:floor( 11.5 ) =', data: 'd2:floor( 11.5 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'X0sBuEr253I', content: "d2:concatenate( 'dh', 'is', 2, 'is', 'rocking') = ", data: "d2:concatenate( 'dh', 'is', 2, 'is', 'rocking')", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'BOGjaMS1Doe', content: "d2:countIfValue( 'gender', 'Male' ) = ", data: "d2:countIfValue( 'gender', 'Male' )", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'IgqaoqYrEFj', content: 'd2:yearsBetween( V{current_date}, V{event_date}) = ', data: 'd2:yearsBetween( V{current_date}, V{event_date})', programRuleActionType: 'DISPLAYTEXT' }, { id: 'vBs22fqfrDE', content: "d2:concatenate( d2:concatenate('Serveral', ' strings '), ' in ', d2:concatenate(' a ', ' row ') , ' and ', ' round of 10.5 is ' , d2:round( 10.5 )) ===", data: "d2:concatenate( d2:concatenate('Serveral', ' strings '), ' in ', d2:concatenate(' a ', ' row ') , ' and ', ' round of 10.5 is ' , d2:round( 10.5 ))", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'jsS2bOs5qmh', content: "d2:hasValue( 'age' ) = ", data: "d2:hasValue( 'age' )", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'tn0AItYCSyI', content: 'd2:left(#{age}, 3) = ', data: 'd2:left(#{age}, 3)', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'TTZewggA0bL', content: 'd2:modulus( 12 , 100 ) = ', data: 'd2:modulus( 12 , 100 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'SaXzIg4rwoh', content: "d2:count('age') = ", data: "d2:count('age')", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'kqEl7QNwxNT', content: 'd2:oizp( 10000000 ) = ', data: 'd2:oizp( 10000000 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'SgGtes3T64z', content: 'd2:zing( -2 ) = ', data: 'd2:zing( -2 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'LWkG5xhTp5p', content: 'd2:oizp( -10000000 ) =', data: 'd2:oizp( -10000000 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'jfq3oXP2byS', content: 'd2:daysBetween( V{current_date}, V{event_date}) = ', data: 'd2:daysBetween( V{current_date}, V{event_date})', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'dgZOpCxJda4', content: 'd2:round( 0 ) = ', data: 'd2:round( 0 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'FIF9BwowWjo', content: 'd2:zing( 1000 ) = ', data: 'd2:zing( 1000 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'cqj1r6YDVlP', content: 'display age = ', data: '#{age}', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'cGS3sgUT4V4', content: 'd2:addDays( V{current_date}, 1000000 ) = ', data: 'd2:addDays( V{current_date}, 1000000 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'vX4cPv878NP', content: 'org_unit = ', data: 'V{orgunit_code}', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'hwexhHFmz9y', content: "d2:countIfValue( 'age', 1 ) = ", data: "d2:countIfValue( 'age', 1 )", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'n6TMWMS6l2w', content: "d2:split('these-are-testing-values', '-', 2) = ", data: "d2:split('these-are-testing-values', '-', 2)", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'tdYApakEVPd', content: 'd2:round( 12.5 ) = ', data: 'd2:round( 12.5 )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'kj4hhyZ12aL', content: 'd2:monthsBetween( V{current_date}, V{event_date}) = ', data: 'd2:monthsBetween( V{current_date}, V{event_date})', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'qJKnULgVXKJ', content: 'd2:weeksBetween( V{event_date}, V{current_date} ) = ', data: 'd2:weeksBetween( V{event_date}, V{current_date} )', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'AYBXnXToWum', content: 'd2:ceil(11.3) = ', data: 'd2:ceil(11.3)', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'XXE5aTRlJrn', content: "d2:countIfZeroPos( 'age' ) = ", data: "d2:countIfZeroPos( 'age' )", location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }, { id: 'jEKN22mhLfZ', content: 'd2:right(#{age}, 3) = ', data: 'd2:right(#{age}, 3)', location: 'feedback', programRuleActionType: 'DISPLAYTEXT' }] }];
    const programRulesVariables = [{ id: 'RycV5uDi66i', dataElementId: 'qrur9Dvnyt5', displayName: 'age', programId: 'eBAyeGv0exc', programRuleVariableSourceType: 'DATAELEMENT_NEWEST_EVENT_PROGRAM', useNameForOptionSet: true }, { id: 'zINGRka3g9N', dataElementId: 'oZg33kd9taw', displayName: 'gender', programId: 'eBAyeGv0exc', programRuleVariableSourceType: 'DATAELEMENT_NEWEST_EVENT_PROGRAM', useNameForOptionSet: true }, { id: 'Zj7UnCAulEk.vV9UWAZohSf', displayName: 'Zj7UnCAulEk.vV9UWAZohSf', programRuleVariableSourceType: 'DATAELEMENT_CURRENT_EVENT', dataElementId: 'vV9UWAZohSf', programId: 'eBAyeGv0exc' }, { id: 'Zj7UnCAulEk.GieVkTxp4HH', displayName: 'Zj7UnCAulEk.GieVkTxp4HH', programRuleVariableSourceType: 'DATAELEMENT_CURRENT_EVENT', dataElementId: 'GieVkTxp4HH', programId: 'eBAyeGv0exc' }, { id: 'Zj7UnCAulEk.GieVkTxp4HH', displayName: 'Zj7UnCAulEk.GieVkTxp4HH', programRuleVariableSourceType: 'DATAELEMENT_CURRENT_EVENT', dataElementId: 'GieVkTxp4HH', programId: 'eBAyeGv0exc' }];
    const orgUnit = { id: 'DiszpKrYNg8', name: 'Ngelehun CHC' };
    const optionSet = { pC3N9N77UmT: { id: 'pC3N9N77UmT', displayName: 'Gender', version: 0, valueType: 'TEXT', options: [{ id: 'rBvjJYbMCVx', displayName: 'Male', code: 'Male', translations: [] }, { id: 'Mnp3oXrpAbK', displayName: 'Female', code: 'Female', translations: [] }] } };
    ...
    describe.each([
        [
            {},
            [
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'dEvMKWoR02j', message: "d2:substring('hello dhis 2', 6, 10) =  dhis" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'fHdq0QUOcvk', message: "d2:length( 'dhis2 rocks' ) =  11" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'QCPTGiml5xp', message: 'd2:floor( 11.5 ) = 11' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'X0sBuEr253I', message: "d2:concatenate( 'dh', 'is', 2, 'is', 'rocking') =  dhis2isrocking" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'BOGjaMS1Doe', message: "d2:countIfValue( 'gender', 'Male' ) =  0" } },
                { type: 'DISPLAYTEXT', displayText: { id: 'IgqaoqYrEFj', message: 'd2:yearsBetween( V{current_date}, V{event_date}) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'vBs22fqfrDE', message: "d2:concatenate( d2:concatenate('Serveral', ' strings '), ' in ', d2:concatenate(' a ', ' row ') , ' and ', ' round of 10.5 is ' , d2:round( 10.5 )) === Serveral strings  in  a  row  and  round of 10.5 is 11" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'jsS2bOs5qmh', message: "d2:hasValue( 'age' ) =  " } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'tn0AItYCSyI', message: 'd2:left(#{age}, 3) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'TTZewggA0bL', message: 'd2:modulus( 12 , 100 ) =  12' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'SaXzIg4rwoh', message: "d2:count('age') =  0" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'kqEl7QNwxNT', message: 'd2:oizp( 10000000 ) =  1' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'SgGtes3T64z', message: 'd2:zing( -2 ) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'LWkG5xhTp5p', message: 'd2:oizp( -10000000 ) = 0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'jfq3oXP2byS', message: 'd2:daysBetween( V{current_date}, V{event_date}) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'dgZOpCxJda4', message: 'd2:round( 0 ) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'FIF9BwowWjo', message: 'd2:zing( 1000 ) =  1000' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'cqj1r6YDVlP', message: 'display age =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'cGS3sgUT4V4', message: 'd2:addDays( V{current_date}, 1000000 ) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'vX4cPv878NP', message: 'org_unit =  Ngelehun CHC' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'hwexhHFmz9y', message: "d2:countIfValue( 'age', 1 ) =  0" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'n6TMWMS6l2w', message: "d2:split('these-are-testing-values', '-', 2) =  testing" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'tdYApakEVPd', message: 'd2:round( 12.5 ) =  13' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'kj4hhyZ12aL', message: 'd2:monthsBetween( V{current_date}, V{event_date}) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'qJKnULgVXKJ', message: 'd2:weeksBetween( V{event_date}, V{current_date} ) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'AYBXnXToWum', message: 'd2:ceil(11.3) =  12' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'XXE5aTRlJrn', message: "d2:countIfZeroPos( 'age' ) =  " } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'jEKN22mhLfZ', message: 'd2:right(#{age}, 3) =  ' } },
            ],
        ],
        [
            { oZg33kd9taw: 'Male', /* age */qrur9Dvnyt5: 0, eventDate: '2020-04-29T22:00:00.000Z' },
            [
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'dEvMKWoR02j', message: "d2:substring('hello dhis 2', 6, 10) =  dhis" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'fHdq0QUOcvk', message: "d2:length( 'dhis2 rocks' ) =  11" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'QCPTGiml5xp', message: 'd2:floor( 11.5 ) = 11' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'X0sBuEr253I', message: "d2:concatenate( 'dh', 'is', 2, 'is', 'rocking') =  dhis2isrocking" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'BOGjaMS1Doe', message: "d2:countIfValue( 'gender', 'Male' ) =  1" } },
                { type: 'DISPLAYTEXT', displayText: { id: 'IgqaoqYrEFj', message: 'd2:yearsBetween( V{current_date}, V{event_date}) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'vBs22fqfrDE', message: "d2:concatenate( d2:concatenate('Serveral', ' strings '), ' in ', d2:concatenate(' a ', ' row ') , ' and ', ' round of 10.5 is ' , d2:round( 10.5 )) === Serveral strings  in  a  row  and  round of 10.5 is 11" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'jsS2bOs5qmh', message: "d2:hasValue( 'age' ) =  true" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'tn0AItYCSyI', message: 'd2:left(#{age}, 3) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'TTZewggA0bL', message: 'd2:modulus( 12 , 100 ) =  12' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'SaXzIg4rwoh', message: "d2:count('age') =  1" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'kqEl7QNwxNT', message: 'd2:oizp( 10000000 ) =  1' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'SgGtes3T64z', message: 'd2:zing( -2 ) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'LWkG5xhTp5p', message: 'd2:oizp( -10000000 ) = 0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'jfq3oXP2byS', message: 'd2:daysBetween( V{current_date}, V{event_date}) =  2' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'dgZOpCxJda4', message: 'd2:round( 0 ) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'FIF9BwowWjo', message: 'd2:zing( 1000 ) =  1000' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'cqj1r6YDVlP', message: 'display age =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'cGS3sgUT4V4', message: 'd2:addDays( V{current_date}, 1000000 ) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'vX4cPv878NP', message: 'org_unit =  Ngelehun CHC' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'hwexhHFmz9y', message: "d2:countIfValue( 'age', 1 ) =  0" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'n6TMWMS6l2w', message: "d2:split('these-are-testing-values', '-', 2) =  testing" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'tdYApakEVPd', message: 'd2:round( 12.5 ) =  13' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'kj4hhyZ12aL', message: 'd2:monthsBetween( V{current_date}, V{event_date}) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'qJKnULgVXKJ', message: 'd2:weeksBetween( V{event_date}, V{current_date} ) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'AYBXnXToWum', message: 'd2:ceil(11.3) =  12' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'XXE5aTRlJrn', message: "d2:countIfZeroPos( 'age' ) =  " } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'jEKN22mhLfZ', message: 'd2:right(#{age}, 3) =  0' } },
            ],
        ],
        [
            { oZg33kd9taw: 'Male', /* age */qrur9Dvnyt5: 1000000000, eventDate: '2020-04-29T22:00:00.000Z' },
            [
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'dEvMKWoR02j', message: "d2:substring('hello dhis 2', 6, 10) =  dhis" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'fHdq0QUOcvk', message: "d2:length( 'dhis2 rocks' ) =  11" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'QCPTGiml5xp', message: 'd2:floor( 11.5 ) = 11' } },
                ...
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'vBs22fqfrDE', message: "d2:concatenate( d2:concatenate('Serveral', ' strings '), ' in ', d2:concatenate(' a ', ' row ') , ' and ', ' round of 10.5 is ' , d2:round( 10.5 )) === Serveral strings  in  a  row  and  round of 10.5 is 11" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'jsS2bOs5qmh', message: "d2:hasValue( 'age' ) =  true" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'tn0AItYCSyI', message: 'd2:left(#{age}, 3) =  100' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'TTZewggA0bL', message: 'd2:modulus( 12 , 100 ) =  12' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'SaXzIg4rwoh', message: "d2:count('age') =  1" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'kqEl7QNwxNT', message: 'd2:oizp( 10000000 ) =  1' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'SgGtes3T64z', message: 'd2:zing( -2 ) =  0' } },
                ...
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'dgZOpCxJda4', message: 'd2:round( 0 ) =  0' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'FIF9BwowWjo', message: 'd2:zing( 1000 ) =  1000' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'cqj1r6YDVlP', message: 'display age =  1000000000' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'cGS3sgUT4V4', message: 'd2:addDays( V{current_date}, 1000000 ) =  ' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'vX4cPv878NP', message: 'org_unit =  Ngelehun CHC' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'hwexhHFmz9y', message: "d2:countIfValue( 'age', 1 ) =  0" } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'n6TMWMS6l2w', message: "d2:split('these-are-testing-values', '-', 2) =  testing" } },
                ...
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'AYBXnXToWum', message: 'd2:ceil(11.3) =  12' } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'XXE5aTRlJrn', message: "d2:countIfZeroPos( 'age' ) =  " } },
                { type: 'DISPLAYTEXT', id: 'feedback', displayText: { id: 'jEKN22mhLfZ', message: 'd2:right(#{age}, 3) =  000' } },
            ],
        ],
    ])('field will be hidden', (events, expected) => {
        test(`and given value is ${JSON.stringify(events)}`, () => {
            // given
            const { currentEvent, allEvents } = {
                currentEvent: events,
