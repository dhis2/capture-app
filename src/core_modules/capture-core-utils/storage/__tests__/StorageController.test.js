...
const Adapters = [
  availableAdapters.INDEXED_DB,
  availableAdapters.LOCAL_STORAGE,
  availableAdapters.MEMORY,
];
...
beforeEach(() => {
  ...
  testCnt += 1;
  storageController = new StorageController(dbName, 2, {
    Adapters,
...
it('set all data', async () => {
  await storageController.open();
  await storageController.setAll(storeNames[0], [
    { id: '1', name: 'test' },
    { id: '2', name: 'test2' },
  ]);
});
