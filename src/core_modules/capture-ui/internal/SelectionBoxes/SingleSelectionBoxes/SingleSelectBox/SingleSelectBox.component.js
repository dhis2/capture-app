      ...
      <div>
        <label
          ...
          className={classNames(defaultClasses.label, {
            [defaultClasses.labelDisabled]: disabled,
          })}
        >
          ...
          <div className={defaultClasses.iconFocusContainer}>
            <div
              className={
                inFocus ? classNames(defaultClasses.inFocus, focusClass) : classNames(unFocusClass)
              }
            />
            <div className={defaultClasses.iconContainer}>{children}</div>
          </div>
          <span className={defaultClasses.name}>{optionData.name}</span>
        </label>
      </div>
    );
  }
