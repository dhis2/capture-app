...
test('TEI rules engine effects with functions and effects', () => {
  ...
  expect(rulesEffects).toEqual([
    ...
    },
    {
      type: 'DISPLAYTEXT',
      id: 'feedback',
      displayText: { id: 'wmAQnxbs7V8', message: 'd2:round( 12.5 ) =  13' },
    },
    {
      type: 'DISPLAYTEXT',
      id: 'feedback',
    ...
    },
    {
      type: 'DISPLAYTEXT',
      id: 'feedback',
      displayText: { id: 'xZpYbFPXWG2', message: 'd2:zing( 1000 ) =  1000' },
    },
    {
      type: 'DISPLAYTEXT',
      id: 'feedback',
    ...
    },
    {
      type: 'DISPLAYTEXT',
      id: 'feedback',
      displayText: { id: 'RXmprywJ0Rb', message: 'd2:floor( 11.5 ) =  11' },
    },
    {
      type: 'DISPLAYTEXT',
      id: 'feedback',
