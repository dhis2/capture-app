...
describe('Event Event rules engine', () => {
    ...
    describe.each([
        ...
        [
            { vANAXwtLwcT: 9 },
            [{ id: 'Ok9OQpitjQr', isDataElementId: true, type: 'HIDEFIELD' }],
        ],
        [
            { vANAXwtLwcT: 99 },
            [{ id: 'Ok9OQpitjQr', isDataElementId: true, type: 'HIDEFIELD' }],
        ...
        [
            { vANAXwtLwcT: 100 },
            [{ id: 'vANAXwtLwcT', isDataElementId: true, message: 'The hemoglobin value cannot be above 99 ', type: 'SHOWERROR' }, { id: 'Ok9OQpitjQr', isDataElementId: true, type: 'HIDEFIELD' }],
        ],
    ...
    describe.each([
        [
            { sWoqcoByYmD: true },
            [{ id: 'vANAXwtLwcT', isDataElementId: true, message: 'Hemoglobin value lower than normal ', type: 'SHOWWARNING' }],
        ],
        [
            { sWoqcoByYmD: false },
            [{ id: 'vANAXwtLwcT', isDataElementId: true, message: 'Hemoglobin value lower than normal ', type: 'SHOWWARNING' }, { id: 'Ok9OQpitjQr', isDataElementId: true, type: 'HIDEFIELD' }],
...
describe('Event rules engine', () => {
    ...
    describe.each([
        ...
        [
            ...
            [{ id: 'SWfdB5lX0fk', isDataElementId: true, type: 'HIDEFIELD' }, { displayKeyValuePair: { id: 'x7PaHGvgWY2', key: 'BMI', value: NaN }, id: 'indicators', type: 'DISPLAYKEYVALUEPAIR' }],
        ],
        [
    ...
    describe.each([
        [
            ...
            [
                ...
                { type: 'HIDEOPTION', id: 'ovY6E8BSdto', isDataElementId: true, optionId: 'MkeWrqeqZXL' },
                { type: 'HIDEOPTION', id: 'ovY6E8BSdto', isDataElementId: true, optionId: 'fPV0gQ8ds6D' },
                { type: 'HIDEOPTION', id: 'JGnHr6WI3AY', isDataElementId: true, optionId: 'pqxvAQU1z9W' },
                { type: 'HIDEOPTION', id: 'p8htbyJHydl', isDataElementId: true, optionId: 'pqxvAQU1z9W' },
                { type: 'HIDEOPTION', id: 'CUbZcLm9LyN', isDataElementId: true, optionId: 'pqxvAQU1z9W' },
                { type: 'HIDEFIELD', id: 'A4Fg6jgWauf', isDataElementId: true },
                { type: 'HIDEFIELD', id: 'jBBkFuPKctq', isDataElementId: true },
                { type: 'HIDEOPTION', id: 'bOYWVEBaWy6', isDataElementId: true, optionId: 'dUeRcF2cApV' },
                { type: 'HIDEOPTION', id: 'bOYWVEBaWy6', isDataElementId: true, optionId: 'bYt4why1tL3' },
                { type: 'HIDEOPTION', id: 'bOYWVEBaWy6', isDataElementId: true, optionId: 'xBoo6HyaYcd' },
                { type: 'HIDEOPTION', id: 'bOYWVEBaWy6', isDataElementId: true, optionId: 'RCT079wdeKT' },
                { type: 'HIDEFIELD', id: 'Z5z8vFQy0w0', isDataElementId: true },
                { type: 'HIDEFIELD', id: 'p8htbyJHydl', isDataElementId: true },
                { type: 'HIDEFIELD', id: 'ovY6E8BSdto', isDataElementId: true },
            ],
        ],
        [
            { QQLXTXVidW2: 'Yes' },
            [
                ...
                { type: 'HIDEOPTION', id: 'ovY6E8BSdto', isDataElementId: true, optionId: 'MkeWrqeqZXL' },
                { type: 'HIDEOPTION', id: 'ovY6E8BSdto', isDataElementId: true, optionId: 'fPV0gQ8ds6D' },
                { type: 'HIDEFIELD', id: 's3eoonJ8OJb', isDataElementId: true },
                { type: 'HIDEOPTION', id: 'JGnHr6WI3AY', isDataElementId: true, optionId: 'pqxvAQU1z9W' },
                { type: 'HIDEOPTION', id: 'p8htbyJHydl', isDataElementId: true, optionId: 'pqxvAQU1z9W' },
                { type: 'HIDEOPTION', id: 'CUbZcLm9LyN', isDataElementId: true, optionId: 'pqxvAQU1z9W' },
                { type: 'HIDEFIELD', id: 'A4Fg6jgWauf', isDataElementId: true },
...
describe('Event rules engine with data elements source from previous events', () => {
    ...
    describe.each([
        ...
        [
            { M4HEOoEFTAT: 12 },
            [{ id: 'cfWdmSsAutR', isDataElementId: true, type: 'HIDEFIELD' }],
        ],
...
describe('Event rules engine with data elements source from the newest event program stage', () => {
    ...
    describe.each([
        ...
        [
            ...
            [{ id: 'cH37ymMQ5QW', isDataElementId: true, type: 'HIDEFIELD' }],
        ],
