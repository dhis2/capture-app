import { rulesEngineEffectScopes } from 'capture-core-utils/rulesEngine';
...
describe('Event Event rules engine', () => {
    ...
    describe.each([
        [
            { vANAXwtLwcT: 0 },
            [{ id: 'vANAXwtLwcT', scope: rulesEngineEffectScopes.DATA_ELEMENT, message: 'Hemoglobin value lower than normal ', type: 'SHOWWARNING' }, { id: 'Ok9OQpitjQr', scope: rulesEngineEffectScopes.DATA_ELEMENT, type: 'HIDEFIELD' }],
        ],
        [
            { vANAXwtLwcT: 9 },
            [{ id: 'Ok9OQpitjQr', scope: rulesEngineEffectScopes.DATA_ELEMENT, type: 'HIDEFIELD' }],
        ],
        [
            { vANAXwtLwcT: 99 },
            [{ id: 'Ok9OQpitjQr', scope: rulesEngineEffectScopes.DATA_ELEMENT, type: 'HIDEFIELD' }],
        ...
        [
            { vANAXwtLwcT: 100 },
            [{ id: 'vANAXwtLwcT', scope: rulesEngineEffectScopes.DATA_ELEMENT, message: 'The hemoglobin value cannot be above 99 ', type: 'SHOWERROR' }, { id: 'Ok9OQpitjQr', scope: rulesEngineEffectScopes.DATA_ELEMENT, type: 'HIDEFIELD' }],
        ],
    ...
    describe.each([
        [
            { sWoqcoByYmD: true },
            [{ id: 'vANAXwtLwcT', scope: rulesEngineEffectScopes.DATA_ELEMENT, message: 'Hemoglobin value lower than normal ', type: 'SHOWWARNING' }],
        ],
        [
            { sWoqcoByYmD: false },
            [{ id: 'vANAXwtLwcT', scope: rulesEngineEffectScopes.DATA_ELEMENT, message: 'Hemoglobin value lower than normal ', type: 'SHOWWARNING' }, { id: 'Ok9OQpitjQr', scope: rulesEngineEffectScopes.DATA_ELEMENT, type: 'HIDEFIELD' }],
...
describe('Event rules engine', () => {
    ...
    describe.each([
        ...
        [
            ...
            [{ id: 'SWfdB5lX0fk', scope: rulesEngineEffectScopes.DATA_ELEMENT, type: 'HIDEFIELD' }, { displayKeyValuePair: { id: 'x7PaHGvgWY2', key: 'BMI', value: NaN }, id: 'indicators', type: 'DISPLAYKEYVALUEPAIR' }],
        ],
        [
    ...
    describe.each([
        [
            ...
            [
                ...
                { type: 'HIDEOPTION', id: 'ovY6E8BSdto', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'MkeWrqeqZXL' },
                { type: 'HIDEOPTION', id: 'ovY6E8BSdto', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'fPV0gQ8ds6D' },
                { type: 'HIDEOPTION', id: 'JGnHr6WI3AY', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'pqxvAQU1z9W' },
                { type: 'HIDEOPTION', id: 'p8htbyJHydl', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'pqxvAQU1z9W' },
                { type: 'HIDEOPTION', id: 'CUbZcLm9LyN', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'pqxvAQU1z9W' },
                { type: 'HIDEFIELD', id: 'A4Fg6jgWauf', scope: rulesEngineEffectScopes.DATA_ELEMENT },
                { type: 'HIDEFIELD', id: 'jBBkFuPKctq', scope: rulesEngineEffectScopes.DATA_ELEMENT },
                { type: 'HIDEOPTION', id: 'bOYWVEBaWy6', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'dUeRcF2cApV' },
                { type: 'HIDEOPTION', id: 'bOYWVEBaWy6', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'bYt4why1tL3' },
                { type: 'HIDEOPTION', id: 'bOYWVEBaWy6', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'xBoo6HyaYcd' },
                { type: 'HIDEOPTION', id: 'bOYWVEBaWy6', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'RCT079wdeKT' },
                { type: 'HIDEFIELD', id: 'Z5z8vFQy0w0', scope: rulesEngineEffectScopes.DATA_ELEMENT },
                { type: 'HIDEFIELD', id: 'p8htbyJHydl', scope: rulesEngineEffectScopes.DATA_ELEMENT },
                { type: 'HIDEFIELD', id: 'ovY6E8BSdto', scope: rulesEngineEffectScopes.DATA_ELEMENT },
            ],
        ],
        [
            { QQLXTXVidW2: 'Yes' },
            [
                ...
                { type: 'HIDEOPTION', id: 'ovY6E8BSdto', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'MkeWrqeqZXL' },
                { type: 'HIDEOPTION', id: 'ovY6E8BSdto', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'fPV0gQ8ds6D' },
                { type: 'HIDEFIELD', id: 's3eoonJ8OJb', scope: rulesEngineEffectScopes.DATA_ELEMENT },
                { type: 'HIDEOPTION', id: 'JGnHr6WI3AY', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'pqxvAQU1z9W' },
                { type: 'HIDEOPTION', id: 'p8htbyJHydl', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'pqxvAQU1z9W' },
                { type: 'HIDEOPTION', id: 'CUbZcLm9LyN', scope: rulesEngineEffectScopes.DATA_ELEMENT, optionId: 'pqxvAQU1z9W' },
                { type: 'HIDEFIELD', id: 'A4Fg6jgWauf', scope: rulesEngineEffectScopes.DATA_ELEMENT },
...
describe('Event rules engine with data elements source from previous events', () => {
    ...
    describe.each([
        ...
        [
            { M4HEOoEFTAT: 12 },
            [{ id: 'cfWdmSsAutR', scope: rulesEngineEffectScopes.DATA_ELEMENT, type: 'HIDEFIELD' }],
        ],
...
describe('Event rules engine with data elements source from the newest event program stage', () => {
    ...
    describe.each([
        ...
        [
            ...
            [{ id: 'cH37ymMQ5QW', scope: rulesEngineEffectScopes.DATA_ELEMENT, type: 'HIDEFIELD' }],
        ],
