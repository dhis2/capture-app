...
*/
function getAssignEffectsBasedOnHideField(
...
export default function postProcessRulesEffects(
  ...
  effectsHierarchy[effectActions.HIDE_FIELD] = filterFieldsHideEffects(
    effectsHierarchy[effectActions.HIDE_FIELD],
    effectsHierarchy[effectActions.MAKE_COMPULSORY],
    foundation,
  );
  effectsHierarchy[effectActions.HIDE_SECTION] = filterSectionsHideEffects(
    effectsHierarchy[effectActions.HIDE_SECTION],
    effectsHierarchy[effectActions.MAKE_COMPULSORY],
    foundation,
  );

  effectsHierarchy[effectActions.ASSIGN_VALUE] = postProcessAssignEffects(
