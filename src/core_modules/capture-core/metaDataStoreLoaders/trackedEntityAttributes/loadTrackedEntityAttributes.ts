 ...
 * The tracked entity attribute ids input is determined from the stale programs (programs where the program version has
 * changed) and
 * the stale tracked entity types (tracked entity types based on programs where the program version has changed)
 * We chunk the tracked entity type attribute ids in chunks of smaller sizes in order to comply with a potential url
 * path limit and
