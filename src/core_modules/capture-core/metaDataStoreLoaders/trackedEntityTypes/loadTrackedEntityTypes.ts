...
const getSideEffects = (() => {
    const getOptionSetsOutline = (trackedEntityTypesOutline: Array<any>): Array<any> =>
    ...
    const getTrackedEntityAttributeIds = (trackedEntityTypes: Array<any>): Array<any> =>
        trackedEntityTypes
            .flatMap(trackedEntityType =>
                ((trackedEntityType as any).trackedEntityTypeAttributes || [])
