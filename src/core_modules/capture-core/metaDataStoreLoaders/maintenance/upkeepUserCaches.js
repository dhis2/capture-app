...
async function addUserCacheToHistory(mainStorageController: StorageController) {
...
async function removeCaches(history: Array<string>, mainStorageController: StorageController) {
  const currentAdapterType = mainStorageController.adapterType;
  const keepCount =
    currentAdapterType === LocalStorageAdapter
