...
export const quickStore = async (
  { query: querySpecification, storeName, convertQueryResponse }: QuickStoreMandatory,
  { queryVariables }: QuickStoreOptions = {},
) => {
  ...
  convertedData &&
    ...
    (await storageController.setAll(storeName, convertedData));
