...
export class ProgramStage {
    ...
    _reportDateToUse!: string | undefined;
    ...
    get reportDateToUse(): string | undefined {
        return this._reportDateToUse;
    }

    set reportDateToUse(reportDate: string | undefined) {
        if (reportDate === 'false') {
    ...
    set minDaysFromStart(minDays: number) {
