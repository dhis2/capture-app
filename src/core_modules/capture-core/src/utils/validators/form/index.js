...
export { default as isValidNegativeInteger } from './integerNegative.validator';
export { default as isValidZeroOrPositiveInteger } from './integerZeroOrPositive.validator';
export { default as isValidNumber } from './number.validator';
