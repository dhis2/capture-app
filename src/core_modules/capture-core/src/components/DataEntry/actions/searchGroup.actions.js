...
export const searchGroupResultCountRetrieved = (count: number, dataEntryKey: string, groupId: string, uids: string) =>
    actionCreator(actionTypes.SEARCH_GROUP_RESULT_COUNT_RETRIVED)({ count, dataEntryKey, groupId, uids });
...
export const searchGroupResultCountRetrievalFailed =
    (
        ...
        actionCreator(actionTypes.SEARCH_GROUP_RESULT_COUNT_RETRIEVAL_FAILED)({ error, dataEntryKey, groupId, uids });

export const filterSearchGroupForCountSearch =
    (searchGroup: Object, uid: string, dataEntryKey: string, contextProps: Object) =>
