...
import { getConvertCoordinateIn, convertCoordinateOut, convertStatusIn, convertStatusOut } from '../../crossPage/converters';
...
export const openEventForEditInDataEntry =
    (eventContainer: ClientEventContainer, orgUnit: Object, foundation: RenderFoundation, program: Program) => {
        ...
        const dataEntryPropsToInclude = [
            ...
            {
                clientId: 'geometry',
                dataEntryId: 'coordinate',
                onConvertIn: getConvertCoordinateIn(foundation),
                onConvertOut: convertCoordinateOut,
            },
            {
                clientId: 'status',
