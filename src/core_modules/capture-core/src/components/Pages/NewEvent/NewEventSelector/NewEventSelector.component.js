    ...
    render() {
        return (
            <div>
                ...
                <WarningDialog onAcceptClick={this.handleAcceptNew} open={this.state.openNewEventWarning} onClose={this.handleClose} titleText="Create New Event" contentText="Are you sure? All unsaved data will be lost." />
            </div>
        );
    }
}
