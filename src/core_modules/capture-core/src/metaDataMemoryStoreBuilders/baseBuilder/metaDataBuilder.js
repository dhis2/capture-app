...
export default async function buildMetaData(locale: string) {
    const programsBuilderPromise = buildPrograms(locale, stores.PROGRAMS, stores.OPTION_SETS, stores.PROGRAM_RULES_VARIABLES, stores.PROGRAM_RULES, stores.PROGRAM_INDICATORS);
