...
export type CachedAttributeValue = { attribute: { id: string }; value: unknown };
...
export type CachedProgramStageDataElementsAsObject = Record<string, CachedProgramStageDataElement>;
