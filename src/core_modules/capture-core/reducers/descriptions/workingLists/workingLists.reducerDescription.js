...
import { actionTypes as columnSelectorActionTypes } from '../../../components/Pages/MainPage/EventsList/ListWrapper/actions/columnSelectorDialog.actions';
import { actionTypes as filterSelectorActionTypes } from '../../../components/Pages/MainPage/EventsList/FilterSelectors/filterSelector.actions';
import { actionTypes as eventListActionTypes } from '../../../components/Pages/MainPage/EventsList/eventsList.actions';
import { actionTypes as listActionTypes } from '../../../components/List/list.actions';
...
export const workingListsTemplatesDesc = createReducerDescription(
  {
    ...
    [workingListsActionTypes.TEMPLATE_UPDATE]: (state, action) => {
      ...
      return {
        ...
        [listId]: {
          ...state[listId],
          templates: [...otherTemplates, updatedTemplate],
        },
      };
    },
    ...
    [workingListsActionTypes.TEMPLATE_ADD_ERROR]: (state, action) => {
      ...
      const selectedTemplateId =
        currentlySelectedTemplateId === clientId
    ...
    [workingListsActionTypes.TEMPLATE_DELETE]: (state, action) => {
      ...
      return {
        ...
        [listId]: {
          ...
          templates: [...otherTemplates, deletedTemplate],
        },
      };
    },
    ...
    [workingListsActionTypes.TEMPLATE_DELETE_ERROR]: (state, action) => {
      ...
      return {
        ...
        [listId]: {
          ...state[listId],
          templates: [...otherTemplates, failedToDeleteTemplate],
        },
      };
    },
  },
...
export const workingListsDesc = createReducerDescription(
  {
    ...
    [workingListsActionTypes.EVENT_LIST_INIT_SUCCESS]: (state, action) => {
      ...
      newState[listId] = {
        order: eventContainers ? eventContainers.map((container) => container.event.eventId) : [],
        type: 'event',
...
export const workingListsColumnsOrderDesc = createReducerDescription(
  {
    ...
    [columnSelectorActionTypes.UPDATE_WORKINGLIST_ORDER]: (state, action) => {
      ...
      const newColumnOrder = columnOrder.map((co) => {
...
export const workingListsStickyFiltersDesc = createReducerDescription(
  {
    ...
    [workingListsActionTypes.EVENT_LIST_INIT_SUCCESS]: (state, action) => {
      ...
      const filtersWithValueOnInit = filters
