...
export const rulesEffectsHiddenFieldsDesc = createReducerDescription({
    [rulesEffectsActionTypes.UPDATE_RULES_EFFECTS]: (state, action) => {
        ...
        const hideEffects: { [id: string]: Array<any> } = action.payload.rulesEffects && action.payload.rulesEffects[effectActions.HIDE_FIELD];
...
export const rulesEffectsCompulsoryFieldsDesc = createReducerDescription({
    [rulesEffectsActionTypes.UPDATE_RULES_EFFECTS]: (state, action) => {
        ...
        const compulsoryEffects: { [id: string]: Array<any> } = action.payload.rulesEffects && action.payload.rulesEffects[effectActions.MAKE_COMPULSORY];
...
export const rulesEffectsHiddenSectionsDesc = createReducerDescription({
    [rulesEffectsActionTypes.UPDATE_RULES_EFFECTS]: (state, action) => {
        ...
        const hideEffects: { [id: string]: Array<any> } = action.payload.rulesEffects && action.payload.rulesEffects[effectActions.HIDE_SECTION];
        newState[action.payload.formId] = hideEffects ?
            Object.keys(hideEffects).reduce((accState, key) => {
                accState[key] = true;
                return accState;
...
export const rulesEffectsHiddenProgramStageDesc = createReducerDescription({
    [rulesEffectsActionTypes.UPDATE_RULES_EFFECTS]: (state, action) => {
        ...
        const hideEffects: { [id: string]: Array<any> } = action.payload.rulesEffects && action.payload.rulesEffects[effectActions.HIDE_PROGRAM_STAGE];
        newState[action.payload.formId] = hideEffects ?
            Object.keys(hideEffects).reduce((accState, key) => {
                accState[key] = true;
                return accState;
...
export const rulesEffectsErrorMessagesDesc = createReducerDescription({
    [rulesEffectsActionTypes.UPDATE_RULES_EFFECTS]: (state, action) => {
        ...
        const errorEffects: { [id: string]: Array<any> } = action.payload.rulesEffects && action.payload.rulesEffects[effectActions.SHOW_ERROR];
        const warningEffects: { [id: string]: Array<any> } = action.payload.rulesEffects && action.payload.rulesEffects[effectActions.SHOW_WARNING];
        const errorEffectsOnComplete: { [id: string]: Array<any> } = action.payload.rulesEffects && action.payload.rulesEffects[effectActions.SHOW_ERROR_ONCOMPLETE];
        const warningEffectsOnComplete: { [id: string]: Array<any> } = action.payload.rulesEffects && action.payload.rulesEffects[effectActions.SHOW_WARNING_ONCOMPLETE];
...
export const rulesEffectsFeedbackDesc = createReducerDescription({
    [rulesEffectsActionTypes.UPDATE_RULES_EFFECTS]: (state, action) => {
        ...
        const displayTextEffects: { [id: string]: Array<any> } = action.payload.rulesEffects && action.payload.rulesEffects[effectActions.DISPLAY_TEXT];
        const displayKeyValuePairEffects: { [id: string]: Array<any> } = action.payload.rulesEffects && action.payload.rulesEffects[effectActions.DISPLAY_KEY_VALUE_PAIR];
...
export const rulesEffectsGeneralErrorsDesc = createReducerDescription({
    [rulesEffectsActionTypes.UPDATE_RULES_EFFECTS]: (state, action) => {
        ...
        const errorEffects: { [id: string]: Array<any> } =
            action.payload.rulesEffects && action.payload.rulesEffects[effectActions.SHOW_ERROR];
        const errorEffectsOnComplete: { [id: string]: Array<any> } =
...
export const rulesEffectsGeneralWarningsDesc = createReducerDescription({
    [rulesEffectsActionTypes.UPDATE_RULES_EFFECTS]: (state, action) => {
        ...
        const warningsEffects: { [id: string]: Array<any> } =
            action.payload.rulesEffects && action.payload.rulesEffects[effectActions.SHOW_WARNING];
        const warningsEffectsOnComplete: { [id: string]: Array<any> } =
