...
export const rulesEffectsErrorMessagesDesc = createReducerDescription(
  {
    [actionTypes.UPDATE_RULES_EFFECTS]: (state, action) => {
      ...
      const errorEffectsOnComplete: { [id: string]: Array<OutputEffect> } =
        action.payload.rulesEffects &&
        action.payload.rulesEffects[effectActions.SHOW_ERROR_ONCOMPLETE];
      const warningEffectsOnComplete: { [id: string]: Array<OutputEffect> } =
        action.payload.rulesEffects &&
...
export const rulesEffectsFeedbackDesc = createReducerDescription(
  {
    [actionTypes.UPDATE_RULES_EFFECTS]: (state, action) => {
      ...
      const displayKeyValuePairEffects: { [id: string]: Array<OutputEffect> } =
        action.payload.rulesEffects &&
