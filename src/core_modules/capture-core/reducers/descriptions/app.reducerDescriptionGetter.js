...
import { actionTypes as setCurrentSelectionsActionTypes } from '../../components/LockedSelector/QuickSelector/actions/QuickSelector.actions';
...
export const getAppReducerDesc = (appUpdaters: Updaters) =>
  createReducerDescription(
    {
      ...
      [newEventPageSelectionsIncompleteActionTypes.CANCEL_NEW_EVENT_FROM_INCOMPLETE_SELECTIONS_RETURN_TO_MAIN_PAGE]: (
        state,
      ) => {
        const newState = { ...state };
        newState.page = null;
