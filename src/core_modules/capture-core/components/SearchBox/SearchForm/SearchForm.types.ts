...
export type OwnProps = {
    ...
    filteredUnsupportedAttributes?: Array<{
        id: string;
        displayName: string;
        valueType: string;
        searchable: boolean;
...
export type DispatchersFromRedux = {
    ...
    searchViaAttributesOnScopeProgram: ({ programId, formId, resultsPageSize }: { programId: string; formId: string; resultsPageSize: number }) => void;
    searchViaAttributesOnScopeTrackedEntityType: ({ trackedEntityTypeId, formId, resultsPageSize }: { trackedEntityTypeId: string; formId: string; resultsPageSize: number }) => void;
    saveCurrentFormData: ({ searchScopeType, searchScopeId, formId, formsValues, searchGroupsForSelectedScope }: { searchScopeType: string; searchScopeId: string; formId: string; formsValues: FormsValues; searchGroupsForSelectedScope: SearchGroups }) => void;
