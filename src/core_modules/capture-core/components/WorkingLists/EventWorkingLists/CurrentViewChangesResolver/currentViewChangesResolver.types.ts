...
type RestProps = Omit<EventWorkingListsColumnSetupOutputProps & { initialViewConfig: InitialViewConfig },
    keyof (ExtractedProps & { initialViewConfig: InitialViewConfig })>;

export type Props = RestProps & ExtractedProps;

export type CurrentViewChangesResolverOutputProps = RestProps & {
    filters?: FiltersData,
    columns: EventWorkingListsColumnConfigs,
    sortById?: string,
    sortByDirection?: string,
