...
import type { Props } from './TrackerWorkingListSetup.types';
...
import type { TrackerWorkingListColumnConfigs } from '../types';
...
export const TrackerWorkingListSetup = ({
    program,
    programStageId,
    onUpdateList,
    onLoadView,
    ...
    const columns = useColumns<TrackerWorkingListColumnConfigs>(customColumnOrder, defaultColumns);
