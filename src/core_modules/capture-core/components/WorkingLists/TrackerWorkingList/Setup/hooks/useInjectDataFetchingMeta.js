...
import type {
    ...
    TrackerWorkingListColumnConfigs,
    TrackerWorkingListColumnConfig,
    LoadTeiView,
} from '../../types';
...
export const useInjectDataFetchingMetaToLoadList = (
    defaultColumns: TrackerWorkingListColumnConfigs,
    ...
    useCallback(
        (selectedTemplate: Object, context: Object) => {
            const columnsMetaForDataFetching: TeiColumnsMetaForDataFetching = new Map(
                defaultColumns.map((defaultColumn: TrackerWorkingListColumnConfig) => {
