...
import { initTrackerWorkingListViewAsync, updateTrackerWorkingListRecords } from './helpers';
...
export const initTeiViewEpic = (
    ...
    action$.pipe(
        ...
        concatMap((action) => {
            ...
            return from(initTrackerWorkingListViewAsync({
                programId,
                orgUnitId,
                storeId,
                selectedTemplate,
...
export const updateTeiListEpic = (
    ...
    action$.pipe(
        ...
        concatMap((action) => {
            ...
            return from(updateTrackerWorkingListRecords({
                page,
                pageSize,
                programId,
                programStageId,
