...
export type TrackerWorkingListTemplate = {
    id: string,
    isDefault?: ?boolean,
    name: string,
    access: {
...
export type TrackerWorkingListTemplates = Array<TrackerWorkingListTemplate>;
...
export type TrackerWorkingListColumnConfig = MetadataColumnConfig | MainColumnConfig;

export type TrackerWorkingListColumnConfigs = Array<TrackerWorkingListColumnConfig>;
...
export type LoadTeiView = (
    template: TrackerWorkingListTemplate,
    context: {|
        programId: string,
        orgUnitId: string,
