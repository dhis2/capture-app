...
const WidgetIndicatorContentComponent = ({ widgetData, emptyText, classes }: ContentTypeWithClasses) => {
...
export const WidgetIndicatorContent = withStyles(styles)(WidgetIndicatorContentComponent);
