...
import type { PlainProps, Props } from './actions.types';
import { LoadingMaskForButton } from '../../LoadingMasks';
import { MapModal } from '../MapModal';
import { Transfer } from './Transfer';
import { TransferModal } from '../TransferModal';
import type { EnrollmentWithGeometry } from '../MapModal/MapModal.types';
...
export const ActionsPlain = ({
    enrollment = {} as EnrollmentWithGeometry,
    events,
    programStages,
    ownerOrgUnitId,
    tetName,
    ...
    return (
        <>
            ...
            >
                {String(i18n.t('Enrollment actions'))}
            </DropdownButton>
            {loading && (
                <div className={classes.loading}>
                    <LoadingMaskForButton />
                    &nbsp;
                    {String(i18n.t('We are processing your request.'))}
                </div>
            )}
            {isOpenMap && <MapModal
                enrollment={enrollment as EnrollmentWithGeometry}
                onUpdate={handleOnUpdate}
...
export const ActionsComponent = withStyles(styles)(ActionsPlain) as ComponentType<Omit<Props, 'classes'>>;
