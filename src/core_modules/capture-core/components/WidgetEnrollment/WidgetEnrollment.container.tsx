...
const useError = (errorEnrollment: any, errorProgram: any, errorOwnerOrgUnit: any, errorOrgUnit: any) =>
    useMemo(
        () => errorEnrollment ?? errorProgram ?? errorOwnerOrgUnit ?? errorOrgUnit,
        [errorEnrollment, errorProgram, errorOwnerOrgUnit, errorOrgUnit],
    );
...
export const WidgetEnrollment = ({
    ...
    const error = useError(errorEnrollment, errorProgram, errorOwnerOrgUnit, errorOrgUnit);
