...
const useContainsAutoGeneratedEvent = (program: any) =>
    useMemo(() => program?.programStages.some(({ autoGenerateEvent }: { autoGenerateEvent: boolean }) => autoGenerateEvent), [program]);
...
export const WidgetEnrollment = ({
    ...
    return (
        <WidgetEnrollmentNote
            ...
            events={events}
            canAddNew={canAddNew}
            editDateEnabled={!readOnlyMode && program?.access.data.write}
