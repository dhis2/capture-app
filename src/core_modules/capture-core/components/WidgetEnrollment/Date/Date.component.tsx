...
const DateComponentPlain = ({
    ...
    const validateDate = useCallback((dateString: string, internalComponentError: any): ValidationResult => {
        ...
        <div data-test="widget-enrollment-date">
            <div className={classes.inputField}>
                <DateField
                    ...
                    calendarMax={!allowFutureDate ? convertDateObjectToDateFormatString(moment().toDate()) : undefined}
                />
            </div>
            <div className={classes.buttonStrip}>
                ...
                <Button
                    secondary
                    small
                    onClick={() => { setEditMode(false); setValidation({} as ValidationResult); }}
                >
                    {i18n.t('Cancel')}
                </Button>
            </div>
