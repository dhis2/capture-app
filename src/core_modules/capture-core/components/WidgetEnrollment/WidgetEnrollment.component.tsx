...
const WidgetEnrollmentPlain = ({
    ...
    trackedEntityTypeDataWriteAccess,
    ...
    const enrollmentReadOnly = readOnlyMode || !programDataWriteAccess;
                        ...
                        {!hideWidgetBadge && (
                            <div style={{ marginInlineStart: 'auto' }}>
                                <ReadOnlyBadge
                                    ...
                                    programWriteAccess={programDataWriteAccess}
                                    trackedEntityTypeWriteAccess={trackedEntityTypeDataWriteAccess}
