...
const MiniMapPlain = ({
    ...
    const updateEnrollment = useUpdateEnrollment(refetchEnrollment, refetchTEI, onError);
        ...
        <>
            ...
            {isOpenMap && (
                <MapModal
                    ...
                    onUpdate={updateEnrollment.updateMutation}
...
export const MiniMap = withStyles(styles)(MiniMapPlain) as ComponentType<Omit<MiniMapProps, 'classes'>>;
