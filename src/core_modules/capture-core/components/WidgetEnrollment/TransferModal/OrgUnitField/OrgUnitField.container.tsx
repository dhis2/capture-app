...
type Props = {
    ...
    onSelectClick: (orgUnit: any) => void;
    classes: {
        root: string;
...
export const OrgUnitFieldPlain = ({ selected, onSelectClick, classes }: Props) => {
    ...
    const { orgUnitRoots } = useSearchScopeWithFallback({ searchText: searchText || undefined });
        ...
        <div className={classes.root}>
            ...
            <div className={classes.orgUnitTreeContainer}>
                <OrgUnitTreeComponent
                    ...
                    roots={orgUnitRoots}
                    selected={{ path: selected.path[0] || '', id: selected.id }}
