...
export const WidgetEnrollmentPlain = ({
    ...
    const updateEnrolledAt = useCallback((date: string) => ({ ...enrollment, enrolledAt: date }), [enrollment]);
    const updateOccurredAt = useCallback((date: string) => ({ ...enrollment, occurredAt: date }), [enrollment]);
                ...
                {!error && !loading && (
                    <div className={classes.enrollment}>
                        ...
                        <EnrollmentDate
                            ...
                            createPayload={updateEnrolledAt}
                        ...
                        {program.displayIncidentDate && (
                            <EnrollmentDate
                                ...
                                editEnabled={editDateEnabled}
                                displayAutoGeneratedEventWarning={displayAutoGeneratedEventWarning}
                                createPayload={updateOccurredAt}
                                onUpdateDate={onUpdateIncidentDate}
                                onError={onError}
                                classes={classes}
                            />
                        )}
