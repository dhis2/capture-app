...
export const WidgetEnrollmentPlain = ({
    ...
    const updateEnrolledAt = useCallback(({ date, updateMutation }) => {
        const updatedEnrollment = { ...enrollment, enrolledAt: date };
        setEnrollment(updatedEnrollment);
        onUpdateEnrollmentDate && onUpdateEnrollmentDate(date);
        updateMutation && updateMutation(updatedEnrollment);
    }, [enrollment, setEnrollment, onUpdateEnrollmentDate]);

    const updateOccurredAt = useCallback(({ date, updateMutation }) => {
        const updatedEnrollment = { ...enrollment, occurredAt: date };
        setEnrollment(updatedEnrollment);
        onUpdateIncidentDate && onUpdateIncidentDate(date);
        updateMutation && updateMutation(updatedEnrollment);
    }, [enrollment, setEnrollment, onUpdateIncidentDate]);
