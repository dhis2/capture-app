    ...
    return (
        <div data-test="widget-enrollment">
            ...
            >
                ...
                {!initError && !loading && (
                    <div className="enrollment" data-test="widget-enrollment-contents">
                        <div className="statuses" data-test="widget-enrollment-status">
                            {enrollment.followUp && (
                                <Tag className="followup" negative>
                                    {i18n.t('Follow-up')}
                                </Tag>
                            )}
                        ...
                        <div className="row" data-test="widget-enrollment-orgunit">
                            <span className="icon" data-test="widget-enrollment-icon-orgunit">
                        ...
                        <div className="row" data-test="widget-enrollment-owner-orgunit">
                            <span className="icon" data-test="widget-enrollment-icon-owner-orgunit">
                                <IconDimensionOrgUnit16 color={colors.grey600} />
                            </span>
                        ...
                        <div className="row" data-test="widget-enrollment-last-update">
                            <span className="icon" data-test="widget-enrollment-icon-clock">
            ...
            <style jsx>{`
                ...
                .icon {
                    margin-right: ${spacersNum.dp8}px;
                }
