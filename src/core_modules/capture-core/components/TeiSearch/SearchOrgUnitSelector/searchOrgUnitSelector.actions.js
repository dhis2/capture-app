...
export const setOrgUnitScope = (searchId: string, orgUnitScope: string) =>
  actionCreator(actionTypes.TEI_SEARCH_SET_ORG_UNIT_SCOPE)({
    searchId,
    orgUnitScope,
  });
...
export const requestFilterOrgUnits = (searchId: string, searchText: string) =>
  actionCreator(actionTypes.TEI_SEARCH_REQUEST_FILTER_ORG_UNITS)({
    searchId,
    searchText,
  });
...
export const filterOrgUnitsFailed = (searchId: string, error: any) =>
  actionCreator(actionTypes.TEI_SEARCH_FILTER_ORG_UNITS_FAILED)({
    searchId,
    error,
  });
