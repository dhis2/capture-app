...
export const teiSearchFilterOrgUnitsEpic = (action$: any, store: any, { querySingleResource }: any) =>
    action$.pipe(
        ...
        concatMap((action: any) => {
            ...
            }).then(({ organisationUnits }: any) => ({ regUnitArray: organisationUnits, searchText, searchId }))
                .catch((error: any) => ({ error, searchId })))
