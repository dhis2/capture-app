...
export const initializeTeiSearch = (
  searchId: string,
  programId: ?string,
  trackedEntityTypeId: ?string,
) =>
  actionCreator(actionTypes.INITIALIZE_TEI_SEARCH)({
    searchId,
    programId,
    trackedEntityTypeId,
  });
...
export const requestSearchTei = (
  ...
  actionCreator(actionTypes.REQUEST_SEARCH_TEI)({
    formId,
    searchGroupId,
    searchId,
    resultsPageSize,
...
export const searchTeiFailed = (formId: string, searchGroupId: string, searchId: string) =>
  actionCreator(actionTypes.SEARCH_TEI_FAILED)({
    formId,
    searchGroupId,
    searchId,
  });
...
export const searchTeiResultRetrieved = (
  ...
  actionCreator(actionTypes.SEARCH_TEI_RESULT_RETRIEVED)({
    data,
    formId,
    searchGroupId,
    searchId,
...
export const setProgramAndTrackedEntityType = (
  ...
  actionCreator(actionTypes.SET_TEI_SEARCH_PROGRAM_AND_TET)({
    searchId,
    programId,
    trackedEntityTypeId,
  });
...
export const searchFormValidationFailed = (
  ...
  actionCreator(actionTypes.SEARCH_FORM_VALIDATION_FAILED)({
    formId,
    searchGroupId,
    searchId,
  });
...
export const teiSearchResultsChangePage = (
  searchId: string,
  pageNumber: number,
  resultsPageSize: number,
) =>
  actionCreator(actionTypes.TEI_SEARCH_RESULTS_CHANGE_PAGE)({
    searchId,
    pageNumber,
    resultsPageSize,
  });
...
export const setOpenSearchGroupSection = (searchId: string, searchGroupId: ?string) =>
  actionCreator(actionTypes.TEI_SEARCH_SET_OPEN_SEARCH_GROUP_SECTION)({
    searchId,
    searchGroupId,
  });
