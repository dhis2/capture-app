...
export const requestSearchTei = (formId: string, searchGroupId: string, searchId: string) =>
  actionCreator(actionTypes.REQUEST_SEARCH_TEI)({ formId, searchGroupId, searchId });

export const searchTeiFinished = (formId: string, searchGroupId: string, searchId: string) =>
  actionCreator(actionTypes.REQUEST_SEARCH_TEI)({ formId, searchGroupId, searchId });
