...
class TeiSearchPlain extends React.Component<Props, State> {
        ...
        header={
          <SectionHeaderSimple
            ...
            onChangeCollapseState={() => {
              this.setState({
                programSectionOpen: !!isCollapsed,
              });
            }}
  ...
  renderSearchGroups = (searchGroups: Array<SearchGroup>) =>
        ...
        <Section
          ...
          header={
            <SectionHeaderSimple
              ...
              onChangeCollapseState={() => {
                this.onChangeSectionCollapseState(searchGroupId);
              }}
              isCollapsed={collapsed}
              title={header}
            />
  ...
  renderSearchResult = () => {
    const { id, searchGroups, getResultsView } = this.props;
    return (
...
export const TeiSearchComponent: ComponentType<$Diff<Props, CssClasses>> = withStyles(getStyles)(
  TeiSearchPlain,
);
