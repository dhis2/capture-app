...
export function convertValue(value: any, type: $Values<typeof dataElementTypes>, metaElement: DataElement) {
...
export function convertValueToEqual(value: any, type: $Values<typeof dataElementTypes>, metaElement: DataElement) {
    if (!value && value !== 0 && value !== false) {
        return value;
    }
