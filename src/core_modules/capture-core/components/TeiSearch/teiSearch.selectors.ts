...
const trackedEntityTypeIdSelector = (state: any, props: any) => state.teiSearch[props.id].selectedTrackedEntityTypeId;
const programIdSelector = (state: any, props: any) => state.teiSearch[props.id].selectedProgramId;
