...
// COMPLETE
export const startCompleteEvent = (eventId: string, id: string) =>
  actionCreator(actionTypes.START_COMPLETE_EVENT)({ eventId, id });

export const completeEventError = (error: string, id: string) =>
...
export const completeValidationFailed = (eventId: string, id: string) =>
  actionCreator(actionTypes.COMPLETE_VALIDATION_FAILED)({ eventId, id });

export const completeAbort = (eventId: string, id: string) =>
  actionCreator(actionTypes.COMPLETE_ABORT)({ eventId, id });

// SAVE
export const startSaveEvent = (eventId: string, id: string) =>
  actionCreator(actionTypes.START_SAVE_EVENT)({ eventId, id });

export const saveEventError = (error: string, id: string) =>
  actionCreator(actionTypes.SAVE_EVENT_ERROR)({ error, id });
...
export const saveValidationFailed = (itemId: string, id: string) =>
  actionCreator(actionTypes.SAVE_VALIDATION_FALED)({ itemId, id });

export const saveAbort = (itemId: string, id: string) =>
  actionCreator(actionTypes.SAVE_ABORT)({ itemId, id });
...
export const updateField = (
  ...
  actionCreator(actionTypes.UPDATE_FIELD)({
    value,
    valueMeta,
    fieldId,
    dataEntryId,
...
export const startRunRulesPostUpdateField = (dataEntryId: string, itemId: string, uid: string) =>
  actionCreator(actionTypes.START_RUN_RULES_POST_UPDATE_FIELD)({
    dataEntryId,
    itemId,
    uid,
  });

export const rulesExecutedPostUpdateField = (dataEntryId: string, itemId: string, uid: string) =>
  actionCreator(actionTypes.RULES_EXECUTED_POST_UPDATE_FIELD)({
    dataEntryId,
    itemId,
    uid,
  });

export const addNote = (dataEntryId: string, itemId: string, note: Object) =>
  actionCreator(actionTypes.ADD_DATA_ENTRY_NOTE)({
    dataEntryId,
    itemId,
    note,
  });

export const removeNote = (dataEntryId: string, itemId: string, noteClientId: string) =>
  actionCreator(actionTypes.REMOVE_DATA_ENTRY_NOTE)({
    dataEntryId,
    itemId,
    noteClientId,
  });

export const setCurrentDataEntry = (dataEntryId: string, itemId: string, extraProps?: ?any) =>
  actionCreator(actionTypes.SET_CURRENT_DATA_ENTRY)({
    dataEntryId,
    itemId,
    extraProps,
  });
...
export const removeRelationship = (
  ...
  actionCreator(actionTypes.REMOVE_DATA_ENTRY_RELATIONSHIP)({
    dataEntryId,
    itemId,
...
export const relationshipAlreadyExists = (dataEntryId: string, itemId: string, message: string) =>
  actionCreator(actionTypes.DATA_ENTRY_RELATIONSHIP_ALREADY_EXISTS)({
    dataEntryId,
    itemId,
    message,
  });

export const loadEditDataEntry = (args: Object) =>
