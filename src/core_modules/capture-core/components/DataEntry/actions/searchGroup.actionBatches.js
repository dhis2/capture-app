...
export const batchActionTypes = {
  ...
  UPDATE_FIELD_AND_RUN_SEARCH_GROUP_SEARCHES_FROM_ASYNC_BATCH:
    'UpdateFieldAndRunSearchGroupSearchesFromAsyncBatch',
...
export const updateFieldAndRunSearchGroupSearchesBatch = (
  ...
  batchActions(
    [innerAction, ...filterActionsToBeExecuted, ...filterActions],
...
export const filteredSearchActionsForSearchBatch = (searchActions: Array<ReduxAction<any, any>>) =>
