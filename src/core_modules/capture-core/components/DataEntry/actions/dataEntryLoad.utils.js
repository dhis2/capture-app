...
export function getDataEntryValues(
  ...
  const standardValuesArray = dataEntryPropsToInclude
    ...
    .map(
      // $FlowFixMe[prop-missing] automated comment
      (propToInclude: DataEntryPropToIncludeStandard) =>
        new DataElement((o) => {
  ...
  return [...standardValuesArray, ...specialValuesArray].reduce(
    (accConvertedValues, valueItem: { id: string, value: any }) => {
...
export function getDataEntryNotes(clientValuesForDataEntry: Object): Array<Object> {
...
export function getFormValues(clientValuesForForm: Object, formFoundation: RenderFoundation) {
