...
const OptionSetFilterWithButtons = withButtons()(OptionSetFilter);
...
const useContents = ({ filterValue, classes, type, options, multiValueFilter, ...passOnProps }) => {
  ...
  return <FilterContents {...passOnProps} filter={filterValue} type={type} />;
};
...
export const FilterSelectorContents: ComponentType<$Diff<Props, CssClasses>> = withStyles(
  getStyles,
)(FilterSelectorContentsPlain);
