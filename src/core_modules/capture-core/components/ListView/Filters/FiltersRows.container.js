...
const useAdditionalFiltersButtons = ({ additionalFilters, stickyFilters, programStageFilterId }) => {
    if (additionalFilters && stickyFilters) {
        ...
        return mainButtonAdditionalFilters
            ? {
                ...
                visibleSelectorId: programStageFilterId ? undefined : mainButtonAdditionalFilters.id,
            }
...
export const FiltersRows = ({
    ...
    const { shouldRenderAdditionalFiltersButtons, visibleSelectorId } = useAdditionalFiltersButtons({
        additionalFilters,
        stickyFilters,
        programStageFilterId: programStageId,
    });
