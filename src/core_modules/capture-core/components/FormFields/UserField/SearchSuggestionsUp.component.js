...
const SearchSuggestionsUp = (props: Props) => {
  ...
  return (
    <div name={suggestionName} tabIndex={-1} onKeyDown={handleKeyDown} role="none">
      <div ref={listUpEl} className={defaultClasses.listUp}>
        <div name={suggestionName} className={defaultClasses.listUpInner}>
          {children}
        </div>
      </div>
    </div>
