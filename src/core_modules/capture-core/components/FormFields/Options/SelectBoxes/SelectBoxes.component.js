...
const SelectBoxes = (props: Props) => {
  ...
  if (multiSelect) {
    return (
      ...
      <MultiSelectBoxes orientation={multiSelectOrientations.HORIZONTAL} {...passOnProps} />
    );
  }

  return (
    // $FlowFixMe[cannot-spread-inexact] automated comment
    <SingleSelectBoxes orientation={singleSelectOrientatins.HORIZONTAL} {...passOnProps} />
  );
};
