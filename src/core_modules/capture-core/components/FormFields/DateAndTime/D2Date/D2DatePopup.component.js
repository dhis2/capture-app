...
class D2DatePopup extends React.Component<Props> {
  ...
  render() {
    const { open, mode, classes, children } = this.props;
    ...
    const containerClasses =
      mode === modes.INLINE ? classes.containerInline : classes.containerAbsolute;
    const calendarClasses =
      mode === modes.INLINE ? classes.calendarInline : classes.calendarAbsolute;
