  ...
  renderInput = () => {
    ...
    return (
      <div className={classes.newNoteFormContainer}>
        ...
        <div
          className={classes.newCommentButtonContainer}
          data-test="dhis2-capture-comment-buttons-container"
        >
    ...
    return (
      <Tooltip title={canAddComment ? '' : i18n.t('You dont have access to write comments')}>
        <div
          ...
          data-test="dhis2-capture-new-comment-button"
        >
        ...
        <List dense className={classes.notesList} data-test="dhis2-capture-comments-list">
          {notes.map((n) => (
            <ListItem
              ...
              key={n.clientId}
              data-test="dhis2-capture-comment"
            >
