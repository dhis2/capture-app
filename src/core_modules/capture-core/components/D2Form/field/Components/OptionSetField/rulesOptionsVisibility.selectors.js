...
const sectionOptionsVisibilitySelector = (state, props) => {
  ...
  return {
    ...
    hideOptionGroups:
      optionsVisibility.hideOptionGroups && optionsVisibility.hideOptionGroups[props.id],
    showOptionGroups:
      optionsVisibility.showOptionGroups && optionsVisibility.showOptionGroups[props.id],
  };
};
export const makeGetOptionsVisibility = () =>
  createDeepEqualOptionsVisibilitySelector(
