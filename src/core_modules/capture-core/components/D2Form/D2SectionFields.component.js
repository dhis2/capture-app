...
const CustomFormHOC = withCustomForm()(
  withDivider()(withAlternateBackgroundColors()(FormBuilderContainer)),
);
type FormsValues = {
  [id: string]: any,
};
...
class D2SectionFields extends Component<Props> {
  ...
  getInvalidFields() {
    ...
    const externalInvalidFields = {
      ...messagesInvalidFields,
      ...rulesCompulsoryInvalidFields,
    };
