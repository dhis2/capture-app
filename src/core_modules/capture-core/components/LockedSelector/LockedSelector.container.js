...
const mapDispatchToProps = (
  ...
  { customActionsOnProgramIdReset = [], customActionsOnOrgUnitIdReset = [] },
) => ({
  ...
  onResetOrgUnitId: () => {
    dispatch(
      batchActions(
        [resetOrgUnitIdFromLockedSelector(), ...customActionsOnOrgUnitIdReset],
...
export const LockedSelector = connect(
  mapStateToProps,
  mapDispatchToProps,
)(withLoadingIndicator()(LockedSelectorComponent));
