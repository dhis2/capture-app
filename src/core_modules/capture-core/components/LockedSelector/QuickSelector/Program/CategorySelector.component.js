...
class CategorySelector extends React.Component<Props, State> {
  static getOptionsAsync(categoryId: string, selectedOrgUnitId: ?string, onIsAborted: Function) {
    ...
    return buildCategoryOptionsAsync(categoryId, {
      predicate,
      project,
      onIsAborted,
    });
