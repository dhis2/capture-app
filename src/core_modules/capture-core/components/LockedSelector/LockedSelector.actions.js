...
export const lockedSelectorActionTypes = {
    ...
    NEW_EVENT_PAGE_OPRN: 'NewEventPageOpen',
...
export const openNewEventPageFromLockedSelector = (programId: string, orgUnitId: string) => actionCreator(lockedSelectorActionTypes.NEW_EVENT_PAGE_OPRN)({ programId, orgUnitId });
