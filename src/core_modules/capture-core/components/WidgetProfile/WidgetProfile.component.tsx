...
import type { InputProgramData } from './hooks/useClientAttributesWithSubvalues';
import {
    useProgram,
...
const showEditModal = (loading: boolean, error: any, showEdit: boolean, modalState: string): boolean =>
...
const WidgetProfilePlain = ({
    ...
    const clientAttributesWithSubvalues = useClientAttributesWithSubvalues(teiId, program as InputProgramData, trackedEntityInstanceAttributes as any || []);
    ...
    const displayInListAttributes = useMemo(() => clientAttributesWithSubvalues
        ...
        .map((clientAttribute) => {
            ...
            const value = convertClientToView(clientAttribute as any);
            return {
    ...
    return (
        <div data-test="profile-widget">
                    ...
                    <div className={classes.header}>
                        ...
                        <div className={classes.actions}>
                            ...
                            <OverflowMenu
                                ...
                                canWriteData={canWriteData || false}
                                trackedEntity={{ trackedEntity: (trackedEntity as any)?.id || '' }}
                                onDeleteSuccess={onDeleteSuccess}
                                displayChangelog={displayChangelog || false}
            ...
            {showEditModal(loading, error, isEditable || false, modalState) && (
                <>
                    <DataEntry
...
export const WidgetProfile = withStyles(styles)(WidgetProfilePlain);
