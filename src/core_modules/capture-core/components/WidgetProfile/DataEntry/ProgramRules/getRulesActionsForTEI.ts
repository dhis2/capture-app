...
const getEnrollmentForRulesExecution = (enrollment?: EnrollmentData | null, programName?: string): Enrollment | null =>
    enrollment && {
...
const getDataElementsForRulesExecution = (dataElements?: DataElements | null) =>
    dataElements &&
    Object.values(dataElements).reduce(
        (acc: any, dataElement: any) => ({
            ...acc,
            [dataElement.id]: {
                id: dataElement.id,
