...
import { OptionSetFactory } from './OptionSetFactory';
...
export class DataElementFactory {
    ...
    cachedTrackedEntityAttributes: Map<string, CachedTrackedEntityAttribute>;
    constructor({ cachedTrackedEntityAttributes, cachedOptionSets }: ConstructorInput) {
    ...
    async _setBaseProperties(
        ...
        dataElement.name = cachedTrackedEntityAttribute.displayName;
        dataElement.shortName = cachedTrackedEntityAttribute.displayShortName;
        dataElement.formName = cachedTrackedEntityAttribute.displayFormName;
        dataElement.description = cachedTrackedEntityAttribute.description;
    ...
    async _buildBaseDataElement(
        ...
        dataElement.type = cachedTrackedEntityAttribute.valueType;
        await this._setBaseProperties(dataElement, cachedProgramTrackedEntityAttribute, cachedTrackedEntityAttribute);
        return dataElement;
    }
    ...
    build(cachedProgramTrackedEntityAttribute: CachedProgramTrackedEntityAttribute) {
        const cachedTrackedEntityAttribute =
            ...
            this.cachedTrackedEntityAttributes.get(cachedProgramTrackedEntityAttribute.trackedEntityAttributeId);
