...
import { AOCFieldBuilderComponent } from './AOCFieldBuilder.component';
import { useCategoryCombinations } from './useCategoryCombinations';

export const AOCFieldBuilder = (props) => {
    ...
    return <AOCFieldBuilderComponent {...props} programCategory={programCategory} fields={fields} />;
};
