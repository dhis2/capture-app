...
import { SingleSelect, SingleSelectOption, colors } from '@dhis2/ui';
...
export const TrackedEntityTypeSelectorPlain = ({
  ...
  return (
    <>
      <div className={classes.header}>{i18n.t('Search for')}</div>
      ...
      {!selectedSearchScopeId && (
        <Grid
          ...
          direction="row"
          alignItems="center"
          className={classes.gridContainerInformativeText}
        >
          <Grid item>
...
export const TrackedEntityTypeSelectorComponent: ComponentType<
  $Diff<Props, CssClasses>,
> = withStyles(styles)(TrackedEntityTypeSelectorPlain);
