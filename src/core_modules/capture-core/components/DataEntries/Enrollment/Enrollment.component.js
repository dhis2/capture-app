  ...
  const enrollmentDateSettings = {
    ...
    getComponentProps: (props: Object) =>
      createComponentProps(props, {
        ...
        calendarMaxMoment: !props.enrollmentMetadata.allowFutureEnrollmentDate
          ? moment()
          : undefined,
      }),
...
const SearchGroupsHOC = withSearchGroups(
  getSearchGroups,
  getSearchContext,
...
const EnrollmentDateFieldHOC = withDataEntryField(getEnrollmentDateSettings())(
  IncidentDateFieldHOC,
);
