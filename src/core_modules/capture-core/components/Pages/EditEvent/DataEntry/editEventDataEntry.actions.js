...
export const batchActionTypes = {
  UPDATE_DATA_ENTRY_FIELD_EDIT_SINGLE_EVENT_ACTION_BATCH:
    'UpdateDataEntryFieldForEditSingleEventActionsBatch',
...
export const actionTypes = {
  ...
  PREREQUISITES_ERROR_OPENING_EVENT_FOR_EDIT_IN_DATA_ENTRY:
    'PrerequisitesErrorOpeningSingleEventForEditInDataEntry',
  ...
  NO_WORKING_LIST_UPDATE_NEEDED_AFTER_CANCEL_UPDATE:
    'NoWorkingListUpdateNeededAfterEventUpdateCancelled',
...
export const openEventForEditInDataEntry = (
  ...
  const dataEntryActions = getLoadActions(
    dataEntryId,
    itemId,
    dataEntryValues,
    formValues,
  ...
  const eventDataForRulesEngine = {
    ...eventContainer.event,
    ...eventContainer.values,
  };
  return [
    ...dataEntryActions,
    ...getRulesActionsForEvent(program, foundation, key, orgUnit, eventDataForRulesEngine, [
...
export const requestSaveReturnToMainPage = (
  itemId: string,
  dataEntryId: string,
...
export const startSaveEditEventAfterReturnedToMainPage = (
  eventId: string,
  serverData: Object,
  selections: Object,
) =>
  actionCreator(actionTypes.START_SAVE_AFTER_RETURNED_TO_MAIN_PAGE)(
    { selections },
    {
      offline: {
        ...
        commit: {
          type: actionTypes.EVENT_UPDATED_AFTER_RETURN_TO_MAIN_PAGE,
          meta: { selections },
        },
        rollback: {
          type: actionTypes.EVENT_UPDATE_FAILED_AFTER_RETURN_TO_MAIN_PAGE,
          meta: { selections },
        },
      },
    },
...
export const requestAddNoteForEditSingleEvent = (
  itemId: string,
  dataEntryId: string,
  note: string,
) =>
  actionCreator(actionTypes.REQUEST_ADD_NOTE_FOR_EDIT_SINGLE_EVENT)({
    itemId,
    dataEntryId,
    note,
  });

export const startAddNoteForEditSingleEvent = (
  eventId: string,
  serverData: Object,
  selections: Object,
  context: Object,
) =>
  actionCreator(actionTypes.START_ADD_NOTE_FOR_EDIT_SINGLE_EVENT)(
    { selections, context },
    {
      offline: {
        effect: {
        ...
        commit: {
          type: actionTypes.NOTE_ADDED_FOR_EDIT_SINGLE_EVENT,
          meta: { selections, context },
        },
        rollback: {
          type: actionTypes.ADD_NOTE_FAILED_FOR_EDIT_SINGLE_EVENT,
          meta: { selections, context },
        },
      },
    },
