...
export const selectionsCompletenessCalculated = (
  ...
  actionCreator(actionTypes.SELECTIONS_COMPLETENESS_CALCULATED)({
    isComplete,
    triggeringActionType,
  });

export const skipCategoriesResetAfterSettingOrgUnit = (triggeringActionType: string) =>
  actionCreator(actionTypes.AFTER_SETTING_ORG_UNIT_SKIP_CATEGORIES_RESET)({
    triggeringActionType,
  });

export const resetCategoriesAfterSettingOrgUnit = (
  resetCategories: Array<string>,
  triggeringActionType: string,
) =>
