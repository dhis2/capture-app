  ...
  ({
    ...
    return (
      <div className={classes.margin}>
        ...
        {navigationButtonsState ===
          availableCardListButtonState.SHOW_VIEW_ACTIVE_ENROLLMENT_BUTTON && (
          <Button
            small
...
export const SearchResultsIndex = ({
  ...
  const currentProgramId =
    currentSearchScopeType === searchScopes.PROGRAM ? currentSearchScopeId : '';
      ...
      {currentSearchScopeType === searchScopes.PROGRAM && !fallbackTriggered && (
        <div className={classes.fallback}>
          <div className={classes.fallbackText}>
            {i18n.t(
              'Not finding the results you were looking for? Try to search all programs that use type ',
            )}
            &quot;{trackedEntityName}&quot;.
          </div>
...
export const SearchResultsComponent: ComponentType<Props> = withStyles(getStyles)(
  SearchResultsIndex,
);
