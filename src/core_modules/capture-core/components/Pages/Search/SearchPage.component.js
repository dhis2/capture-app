...
const Index = ({
  ...
  const [selectedSearchScopeType, setSearchScopeType] = useState(
    ...
    <>
      <ResultsPageSizeContext.Provider value={{ resultsPageSize: 5 }}>
        ...
        <div data-test="dhis2-capture-search-page-content" className={classes.container}>
          ...
          <Paper className={classes.paper}>
            <div className={classes.maxWidth}>
              <div className={classes.title}>Find {titleText}</div>
              ...
              {searchStatus === searchPageStatus.NO_RESULTS && (
                <Modal position="middle">
                  ...
                  <ModalContent>
                    {i18n.t(
                      'You can change your search terms and search again to find what you are looking for.',
                    )}
                  </ModalContent>
                  <ModalActions>
                    <ButtonStrip end>
        ...
        {searchStatus === searchPageStatus.INITIAL && !selectedSearchScopeId && (
          <InefficientSelectionsMessage message={i18n.t('Choose a type to start searching')} />
        )}
