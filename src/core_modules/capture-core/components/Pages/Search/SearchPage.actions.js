...
export const showFallbackNotEnoughAttributesOnSearchPage = ({ minAttributesRequiredToSearchFallback }) =>
    actionCreator(searchPageActionTypes.FALLBACK_NOT_ENOUGH_ATTRIBUTES)({ minAttributesRequiredToSearchFallback });
