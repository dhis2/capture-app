  ...
  renderTopBar = () => {
    ...
    return (
      <div className={classes.topBarContainer}>
        <div className={classes.topBarLeftContainer}>{filterButtons}</div>
        <div className={classes.topBarButtonContainer}>
          <ColumnSelector onSave={this.handleSaveColumnOrder} columns={columns} />
          <ListWrapperMenu listId={listId} customMenuContents={customMenuContents} />
        </div>
      </div>
    );
  };
  ...
  renderPager = () => {
    ...
    return (
      <div className={classes.paginationContainer}>
        <ListPagination listId={this.props.listId} />
      </div>
    );
  };

  renderList = () => {
    const { classes, filterButtons, isUpdatingWithDialog, ...passOnProps } = this.props;
    return <EventList {...passOnProps} />;
  };
