...
export const actionTypes = {
  ...
  UPDATE_INCLUDED_FILTERS_AFTER_COLUMN_SORTING:
    'UpdateIncludedFiltersAfterColumnSortingForWorkingList',
};
...
export const updateIncludedFiltersAfterColumnSorting = (includeFilters: Object, listId: string) =>
  actionCreator(actionTypes.UPDATE_INCLUDED_FILTERS_AFTER_COLUMN_SORTING)({
    includeFilters,
    listId,
  });
