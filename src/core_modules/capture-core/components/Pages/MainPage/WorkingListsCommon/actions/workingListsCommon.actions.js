...
export const fetchTemplates = (programId: string, storeId: string, workingListsType: string) =>
...
export const fetchTemplatesError = (error: string, storeId: string) =>
  actionCreator(workingListsCommonActionTypes.TEMPLATES_FETCH_ERROR)({
    error,
    storeId,
  });

export const fetchTemplatesCancel = (storeId: string) =>
  actionCreator(workingListsCommonActionTypes.TEMPLATES_FETCH_CANCEL)({
    storeId,
  });

export const selectTemplate = (templateId: string, storeId: string) =>
  actionCreator(workingListsCommonActionTypes.TEMPLATE_SELECT)({
    templateId,
    storeId,
  });

export const updateTemplate = (template: Object, criteria: Object, data: Object) =>
  actionCreator(workingListsCommonActionTypes.TEMPLATE_UPDATE)({
    template,
    criteria,
    ...data,
  });
...
export const updateTemplateSuccess = (templateId: string, criteria: Object, data: Object) =>
  actionCreator(workingListsCommonActionTypes.TEMPLATE_UPDATE_SUCCESS)({
    templateId,
    criteria,
    ...data,
  });
...
export const updateTemplateError = (templateId: string, criteria: Object, data: Object) =>
  actionCreator(workingListsCommonActionTypes.TEMPLATE_UPDATE_ERROR)({
    templateId,
    criteria,
    ...data,
  });
...
export const addTemplate = (name: string, criteria: Object, data: Object) =>
  actionCreator(workingListsCommonActionTypes.TEMPLATE_ADD)({
    name,
    criteria,
    ...data,
  });
...
export const addTemplateSuccess = (templateId: string, clientId: Object, data: Object) =>
  actionCreator(workingListsCommonActionTypes.TEMPLATE_ADD_SUCCESS)({
    templateId,
    clientId,
    ...data,
  });
...
export const addTemplateError = (clientId: Object, data: Object) =>
  actionCreator(workingListsCommonActionTypes.TEMPLATE_ADD_ERROR)({
    clientId,
    ...data,
  });
...
export const deleteTemplateSuccess = (template: Object, storeId: string) =>
  actionCreator(workingListsCommonActionTypes.TEMPLATE_DELETE_SUCCESS)({
    template,
    storeId,
  });

export const deleteTemplateError = (template: Object, storeId: string) =>
  actionCreator(workingListsCommonActionTypes.TEMPLATE_DELETE_ERROR)({
    template,
    storeId,
  });

export const initListView = (selectedTemplate: Object, context: Object, meta: Object) =>
  actionCreator(workingListsCommonActionTypes.LIST_VIEW_INIT)({
    ...meta,
    selectedTemplate,
    context,
  });
...
export const initListViewSuccess = (storeId: string, data: Object) =>
  actionCreator(workingListsCommonActionTypes.LIST_VIEW_INIT_SUCCESS)({
    ...data,
    storeId,
  });

export const initListViewError = (storeId: string, errorMessage: string) =>
  actionCreator(workingListsCommonActionTypes.LIST_VIEW_INIT_ERROR)({
    storeId,
    errorMessage,
  });

export const initListViewCancel = (storeId: string) =>
  actionCreator(workingListsCommonActionTypes.LIST_VIEW_INIT_CANCEL)({
    storeId,
  });

export const updateList = (queryArgs: Object, meta: Object) =>
  actionCreator(workingListsCommonActionTypes.LIST_UPDATE)({
    queryArgs,
    ...meta,
  });

export const updateListSuccess = (storeId: string, data: Object) =>
  actionCreator(workingListsCommonActionTypes.LIST_UPDATE_SUCCESS)({
    ...data,
    storeId,
  });

export const updateListError = (storeId: string, errorMessage: string) =>
  actionCreator(workingListsCommonActionTypes.LIST_UPDATE_ERROR)({
    storeId,
    errorMessage,
  });

export const updateListCancel = (storeId: string) =>
  actionCreator(workingListsCommonActionTypes.LIST_UPDATE_CANCEL)({
    storeId,
  });
...
export const sortList = (id: string, direction: string, storeId: string) =>
  actionCreator(workingListsCommonActionTypes.LIST_SORT)({
    id,
    direction,
    storeId,
  });
...
export const setFilter = (filter: Object, itemId: string, storeId: string) =>
  actionCreator(workingListsCommonActionTypes.FILTER_SET)({
    filter,
    itemId,
    storeId,
  });
...
export const clearFilter = (itemId: string, storeId: string) =>
  actionCreator(workingListsCommonActionTypes.FILTER_CLEAR)({
    itemId,
    storeId,
  });

export const selectRestMenuItem = (id: string, storeId: string) =>
  actionCreator(workingListsCommonActionTypes.REST_MENU_ITEM_SELECT)({
    id,
    storeId,
  });
...
export const changePage = (pageNumber: number, storeId: string) =>
  actionCreator(workingListsCommonActionTypes.PAGE_CHANGE)({
    pageNumber,
    storeId,
  });

export const changeRowsPerPage = (rowsPerPage: number, storeId: string) =>
  actionCreator(workingListsCommonActionTypes.ROWS_PER_PAGE_CHANGE)({
    rowsPerPage,
    storeId,
  });
