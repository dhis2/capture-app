...
const EventListUpdater = (props: Props) => {
  ...
  }, [filters, sortById, sortByDirection, currentPage, rowsPerPage, lastEventIdDeleted]);

  return <EventList listId={listId} customMenuContents={customMenuContents} />;
};
