...
const TemplatesManager = (props: Props) => {
  ...
  const { currentTemplate, onSelectTemplate } = React.useContext(ManagerContext);
  ...
  const handleSelectTemplate = React.useCallback(
    ...
    [onSelectTemplate, currentTemplate.id, listId, templates],
  );

  return (
    // $FlowFixMe[prop-missing] automated comment
    <EventListConfig {...passOnProps} listId={listId} currentTemplate={currentTemplate}>
