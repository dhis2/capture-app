...
const typeConvertFilters = (filters: Object, columns: ColumnsForConverter) =>
  Object.keys(filters)
    .map((key) => {
...
const structureFilters = (apiFilters: Array<Object>, columns: ColumnsForConverter) =>
  apiFilters.reduce(
    (acc, filter) => {
...
const getSortOrder = (sortById: string, sortByDirection: string) =>
  `${sortById}:${sortByDirection}`;
