...
export const changeOrgUnit = (orgUnit: ?Object, resetProgramSelection: boolean) =>
  actionCreator(actionTypes.ORG_UNIT_CHANGE)({
    orgUnit,
    resetProgramSelection,
  });

export const searchOrgUnitFailed = () => actionCreator(actionTypes.ORG_UNIT_SEARCH_FAILED)();

export const clearProgramFilter = () => actionCreator(actionTypes.PROGRAM_FILTER_CLEAR)();
