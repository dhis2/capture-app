...
// actions
export { actionTypes as dataEntryActionTypes } from './DataEntry/actions/dataEntry.actions';
export { actionTypes as dataEntryWrapperActionTypes } from './DataEntryWrapper/newEventDataEntryWrapper.actions';
export { actionTypes as newRelationshipActionTypes } from './NewRelationshipWrapper/NewEventNewRelationshipWrapper.actions';
export { actionTypes as selectionsIncompleteActionTypes } from './SelectionsIncomplete/dataEntrySelectionsIncomplete.actions';

// epics
export {
  cancelNewEventEpic,
  cancelNewEventLocationChangeEpic,
} from './DataEntry/epics/cancelNewSingleEvent.epics';
...
export { addNoteForNewSingleEventEpic } from './DataEntry/epics/addNoteForNewSingleEvent.epics';
