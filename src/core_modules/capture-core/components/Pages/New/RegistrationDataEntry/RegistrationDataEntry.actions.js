...
// with enrollment
export const startSavingNewTrackedEntityInstanceWithEnrollment = (formFoundation: RenderFoundation, teiId: string, randomId: string) =>
        ...
        { ...candidateForRegistration },
        {
            offline: {
                ...
                commit: {
                    ...
                    meta: { redirectToEnrollmentEventNew, stageId, randomId },
                },
                rollback: {
