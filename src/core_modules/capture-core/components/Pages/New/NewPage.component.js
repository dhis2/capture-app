...
const NewPagePlain = ({
  ...
  }, [showMessageToSelectOrgUnitOnNewPage, showDefaultViewOnNewPage, currentOrgUnitId]);
        ...
        {newPageStatus === newPageStatuses.DEFAULT && (
          <Paper className={classes.paper}>
            <div className={classes.maxWidth}>
              <div className={classes.title}>New {titleText}</div>
...
export const NewPageComponent: ComponentType<ContainerProps> = compose(
