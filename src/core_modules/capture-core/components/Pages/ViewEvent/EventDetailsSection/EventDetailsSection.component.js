...
class EventDetailsSection extends Component<Props> {
    ...
    return (
      <div className={classes.dataEntryContainer}>
        {showEditEvent ? (
          ...
          <EditEventDataEntry formFoundation={formFoundation} {...passOnProps} />
        ) : (
          // $FlowFixMe[cannot-spread-inexact] automated comment
          <ViewEventDataEntry formFoundation={formFoundation} {...passOnProps} />
        )}
      </div>
    );
  };
  ...
  renderActionsContainer = () => {
    const { classes, onOpenEditEvent, showEditEvent, eventAccess } = this.props;
  ...
  render() {
    ...
    return (
      <div className={classes.container}>
        <ViewEventSection header={<ViewEventSectionHeader text="Event details" icon={InfoIcon} />}>
