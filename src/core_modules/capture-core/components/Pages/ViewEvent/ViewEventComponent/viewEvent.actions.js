...
export const actionTypes = {
  ...
  NO_WORKING_LIST_UPDATE_NEEDED_ON_BACK_TO_MAIN_PAGE:
    'NoWorkingListUpdateNeededOnBackToMainPageForViewEvent',
  ...
  UPDATE_WORKING_LIST_PENDING_ON_BACK_TO_MAIN_PAGE:
...
export const eventFromUrlCouldNotBeRetrieved = (message: string) =>
  actionCreator(actionTypes.EVENT_FROM_URL_COULD_NOT_BE_RETRIEVED)({
    error: message,
  });
...
export const eventFromUrlRetrieved = (
  ...
  actionCreator(actionTypes.EVENT_FROM_URL_RETRIEVED)({
    eventContainer,
    prevProgramId,
    categoriesData,
  });
...
export const orgUnitRetrievedOnUrlUpdate = (orgUnit: Object, eventContainer: Object) =>
  actionCreator(actionTypes.ORG_UNIT_RETRIEVED_ON_URL_UPDATE)({
    orgUnit,
    eventContainer,
  });

export const orgUnitCouldNotBeRetrievedOnUrlUpdate = (eventContainer: Object) =>
  actionCreator(actionTypes.ORG_UNIT_RETRIEVAL_FAILED_ON_URL_UPDATE)({
    eventContainer,
  });

export const startOpenEventForView = (eventContainer: Object, orgUnit: Object) =>
  actionCreator(actionTypes.START_OPEN_EVENT_FOR_VIEW)({
    eventContainer,
    orgUnit,
  });
...
export const startGoBackToMainPage = () => actionCreator(actionTypes.START_GO_BACK_TO_MAIN_PAGE)();
...
export const updateEventContainer = (eventContainer: Object, orgUnit: Object) =>
  actionCreator(actionTypes.UPDATE_EVENT_CONTAINER)({
    eventContainer,
    orgUnit,
  });
