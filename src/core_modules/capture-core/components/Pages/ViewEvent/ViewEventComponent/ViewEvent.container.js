  ...
  return (state: ReduxState) => {
    ...
    return {
      ...
      currentDataEntryKey: eventDetailsSection.showEditEvent
        ? getDataEntryKey(editEventIds.dataEntryId, editEventIds.itemId)
        : getDataEntryKey(viewEventIds.dataEntryId, viewEventIds.itemId),
    };
  };
};
...
export default connect(
  makeMapStateToProps,
  mapDispatchToProps,
)(withErrorMessageHandler()(ViewEvent));
