...
import { placements, inMemoryFileStore } from '../../../DataEntry';
import type { Enrollment, RenderFoundation } from '../../../../metaData';
import { sectionKeysForEnrollmentDataEntry as dataEntrySectionKeys } from '../../../DataEntries';
...
class NewEnrollmentDataEntry extends Component<Props> {
  ...
  dataEntrySections: {
    [$Values<typeof dataEntrySectionKeys>]: DataEntrySection,
  };
