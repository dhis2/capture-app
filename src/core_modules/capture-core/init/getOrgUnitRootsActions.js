...
const defaultFields = 'id,displayName,code,path,publicAccess,access,lastUpdated,children[id,displayName,publicAccess,access,code,path,children::isNotEmpty]';
