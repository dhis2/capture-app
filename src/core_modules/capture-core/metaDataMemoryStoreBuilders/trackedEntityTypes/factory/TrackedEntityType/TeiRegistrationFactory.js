...
class TeiRegistrationFactory {
  ...
  static _buildTetFeatureTypeField(cachedType: CachedTrackedEntityType) {
  ...
  async _buildSection(cachedType: CachedTrackedEntityType) {
  ...
  async _buildFoundation(cachedType: CachedTrackedEntityType) {
  ...
  _buildInputSearchGroupFoundation(cachedType: CachedTrackedEntityType, searchGroup: SearchGroup) {
  ...
  async build(
    ...
    const inputSearchGroups = this._buildInputSearchGroups(
      cachedType,
