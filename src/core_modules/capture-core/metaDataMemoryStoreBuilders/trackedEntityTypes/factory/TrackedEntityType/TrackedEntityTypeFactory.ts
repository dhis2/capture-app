...
export class TrackedEntityTypeFactory {
    ...
    _getTranslation(
        ...
        property: typeof TrackedEntityTypeFactory.translationPropertyNames[
            keyof typeof TrackedEntityTypeFactory.translationPropertyNames
        ],
    ) {
        if (this.locale) {
    ...
    async build(cachedType: CachedTrackedEntityType) {
        const trackedEntityType = new TrackedEntityType((o) => {
            ...
            o.customLabels = extractCustomLabels({
                ...cachedType,
                displayTrackedEntityTypeLabel: cachedType.displayName,
            });
        });
