...
class DataElementFactory {
  ...
  constructor(cachedOptionSets: Map<string, CachedOptionSet>, locale: ?string) {
    this.locale = locale;
  ...
  _getDataElementTranslation(
    ...
    property: $Values<typeof DataElementFactory.propertyNames>,
  ): ?string {
    return (
      this.locale &&
  ...
  async _setBaseProperties(
    ...
    dataElement.shortName =
      this._getDataElementTranslation(
        cachedDataElement,
        DataElementFactory.propertyNames.SHORT_NAME,
      ) || cachedDataElement.displayShortName;
    dataElement.formName =
      this._getDataElementTranslation(
        cachedDataElement,
        DataElementFactory.propertyNames.FORM_NAME,
  ...
  build(cachedProgramStageDataElement: CachedProgramStageDataElement): ?Promise<DataElement> {
