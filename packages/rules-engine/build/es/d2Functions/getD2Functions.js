...
export const getD2Functions = _ref => {
  let {
    dateUtils,
    variablesHash,
    selectedOrgUnit,
  ...
  return {
    ...
    count: {
      ...
      execute: params => {
        ...
        if (!variable) {
          log.warn("could not find variable to count: ".concat(variableName));
          return 0;
        }
    ...
    countIfValue: {
      ...
      execute: params => {
        ...
        if (!variable) {
          log.warn("could not find variable to countIfValue: ".concat(variableName));
          return 0;
        }
    ...
    hasValue: {
      ...
      execute: params => {
        ...
        if (!variable) {
          log.warn("could not find variable to check if has value: ".concat(variableName));
          return false;
        }
    ...
    lastEventDate: {
      ...
      execute: params => {
        ...
        if (!variable) {
          log.warn("could not find variable to check last event date: ".concat(variableName));
          return '';
        }

        if (!variable.variableEventDate) {
          log.warn("no last event date found for variable: ".concat(variableName));
          return '';
        }
    ...
    addControlDigits: {
      ...
      execute: params => {
        ...
        if (baseDigits && baseDigits.length < 10) {
          ...
          log.warn("Base number not well formed(".concat(baseDigits.length, " digits): ").concat(baseNumber));
        }
